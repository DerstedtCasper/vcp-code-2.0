          ...
          let
            ...
            kilo-install-bin = pkgs.writeShellScriptBin "kilo-install" ''
              ...
              if [ "$VERSION" = "latest" ]; then
                url="https://github.com/Kilo-Org/novacode/releases/latest/download/$filename"
                echo "Installing latest version of kilo..." >&2
              else
                # Strip leading 'v' if present
                VERSION="''${VERSION#v}"
                url="https://github.com/Kilo-Org/novacode/releases/download/v''${VERSION}/$filename"
              ...
              if ! ${pkgs.curl}/bin/curl -fsSL -o "$tmp_dir/$filename" "$url"; then
                ...
                echo "Please check your internet connection or visit https://github.com/Kilo-Org/novacode/releases" >&2
                exit 1
              fi
