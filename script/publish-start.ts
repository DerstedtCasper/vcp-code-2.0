...
const skipNotes = process.env["KILO_SKIP_NOTES"] === "1" // novacode_change
if (skipNotes) console.log("changelog skipped: KILO_SKIP_NOTES=1") // novacode_change
...
if (!Script.preview) {
  ...
  // novacode_change start - skip draft flag when KILO_SKIP_NOTES=1 (used by publish-stable.yml which doesn't have a publish-complete step)
