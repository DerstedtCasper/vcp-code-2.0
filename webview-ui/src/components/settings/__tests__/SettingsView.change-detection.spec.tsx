...
vi.mock("@src/context/ExtensionStateContext", () => ({
	// novacode_change: some components access the raw context via `useContext(ExtensionStateContext)`
	ExtensionStateContext: React.createContext<any>(undefined),
	// novacode_change: keep provider available in case a component tree expects it
