import type { Plugin } from "@novacode/plugin"
import { authenticateWithDeviceAuthTUI } from "./auth/device-auth-tui.js"

/**
 * Nova Gateway Authentication Plugin
 *
 * Provides device authorization flow for Nova Gateway
  ...
  return {
    auth: {
      ...
      methods: [
        {
          type: "oauth",
          label: "Nova Gateway (Device Authorization)",
          async authorize() {
