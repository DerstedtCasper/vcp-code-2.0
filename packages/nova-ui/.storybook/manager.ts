...
addons.register("nova-ui/toolbar-visibility", (api) => {
  const update = (globals: Record<string, unknown>) => {
    const isVscode = globals["theme"] === "nova-vscode"
    document.documentElement.setAttribute("data-kilo-theme", isVscode ? "nova-vscode" : "kilo")
  }
