...
const targets = [
  { target: "linux-x64", cliDir: "@novacode/cli-linux-x64", binary: "kilo" },
  { target: "linux-arm64", cliDir: "@novacode/cli-linux-arm64", binary: "kilo" },
  { target: "alpine-x64", cliDir: "@novacode/cli-linux-x64-musl", binary: "kilo" },
  { target: "alpine-arm64", cliDir: "@novacode/cli-linux-arm64-musl", binary: "kilo" },
  { target: "darwin-x64", cliDir: "@novacode/cli-darwin-x64", binary: "kilo" },
  { target: "darwin-arm64", cliDir: "@novacode/cli-darwin-arm64", binary: "kilo" },
  { target: "win32-x64", cliDir: "@novacode/cli-windows-x64", binary: "kilo.exe" },
]
...
for (const config of targets) {
  ...
  const vsixPath = join(outDir, `nova-vscode-${config.target}.vsix`)
