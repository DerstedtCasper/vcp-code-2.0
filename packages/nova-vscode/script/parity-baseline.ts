...
const extensionPath = join(repoRoot, "packages", "nova-vscode", "src", "extension.ts")
const appPath = join(repoRoot, "packages", "nova-vscode", "webview-ui", "src", "App.tsx")
const reportPath = join(repoRoot, "packages", "opencode", "src", "novacode", "docs", "parity-e2e-baseline.md")
