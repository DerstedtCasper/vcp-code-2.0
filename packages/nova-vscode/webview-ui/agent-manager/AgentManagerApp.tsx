...
import { DialogProvider, useDialog } from "@novacode/nova-ui/context/dialog"
import { Dialog } from "@novacode/nova-ui/dialog"
import { DropdownMenu } from "@novacode/nova-ui/dropdown-menu"
import { MarkedProvider } from "@novacode/nova-ui/context/marked"
import { CodeComponentProvider } from "@novacode/nova-ui/context/code"
import { DiffComponentProvider } from "@novacode/nova-ui/context/diff"
import { Code } from "@novacode/nova-ui/code"
import { Diff } from "@novacode/nova-ui/diff"
import { Toast } from "@novacode/nova-ui/toast"
import { ResizeHandle } from "@novacode/nova-ui/resize-handle"
...
import { Spinner } from "@novacode/nova-ui/spinner"
import { Tooltip, TooltipKeybind } from "@novacode/nova-ui/tooltip"
import { HoverCard } from "@novacode/nova-ui/hover-card"
...
const AgentManagerContent: Component = () => {
  ...
  onMount(() => {
    ...
    const unsub = vscode.onMessage((msg) => {
      ...
      // to send the prompt through the normal NovaProvider sendMessage path.
...
export const AgentManagerApp: Component = () => {
  return (
    <ThemeProvider defaultTheme="nova-vscode">
      <DialogProvider>
        <VSCodeProvider>
          <ServerProvider>
            <LanguageBridge>
