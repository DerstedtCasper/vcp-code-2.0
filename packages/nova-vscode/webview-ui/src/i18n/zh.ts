...
export const dict = {
  ...
  "ui.yolo.route.approve": "YOLO 已自动批准此权限",
  "ui.yolo.route.escalate": "YOLO 已将此权限转为人工审批",
  "ui.yolo.confidence": "置信度：{{value}}%",
  "ui.yolo.source": "来源：{{source}}",
  "ui.yolo.source.small_model": "小模型",
  "ui.yolo.source.heuristic": "启发式规则",
  "ui.yolo.reason": "原因：{{reason}}",
  "ui.yolo.reasonFallback": "未提供原因",
  "ui.yolo.manualOverrideHint": "你可以使用下方按钮进行人工覆盖。",
