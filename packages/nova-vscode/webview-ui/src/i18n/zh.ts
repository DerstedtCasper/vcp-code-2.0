...
export const dict = {
  ...
  "settings.vcp.vcptoolbox.baseUrl.description": "VCPToolBox API 的基础地址。",
  "settings.vcp.vcptoolbox.modelsPath.title": "模型路径",
  "settings.vcp.vcptoolbox.modelsPath.description": "用于获取模型列表的路径。",
  "settings.vcp.vcptoolbox.modelsURL.title": "模型 URL",
  "settings.vcp.vcptoolbox.modelsURL.description": "用于模型发现的完整 URL 覆盖。",
  "settings.vcp.vcptoolbox.apiKey.title": "API 密钥",
  "settings.vcp.vcptoolbox.apiKey.description": "发送给 VCPToolBox 请求的 API 密钥。",
