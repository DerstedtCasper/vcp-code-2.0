...
export const dict = {
  ...
  "prompt.action.addContext": "添加上下文 (@)",
  "prompt.action.codebaseIndex": "代码库索引",
  "prompt.action.agentBehaviour": "智能体行为",
  ...
  "prompt.slash.new": "新建会话",
  "prompt.slash.new.desc": "开始新对话",
  "prompt.slash.clear": "清除会话",
  "prompt.slash.clear.desc": "清除当前对话内容",
  "prompt.slash.model": "切换模型",
  "prompt.slash.model.desc": "打开模型选择器",
  "prompt.slash.mode": "切换模式",
  "prompt.slash.mode.desc": "打开模式切换器",
  "prompt.slash.compact": "压缩上下文",
  "prompt.slash.compact.desc": "压缩对话上下文",
  "prompt.slash.enhance": "增强提示词",
  "prompt.slash.enhance.desc": "AI 增强当前输入",

  // 上下文提及与 Pills
  "prompt.mention.contextItems": "上下文项",
  "prompt.mention.remove": "移除",
  "prompt.mention.files": "文件",
  "prompt.mention.directories": "目录",
  "prompt.mention.agents": "智能体",
  "prompt.mention.special": "特殊",
  "prompt.mention.clipboard": "剪贴板内容",
  "prompt.mention.git": "Git 变更",
  "prompt.mention.terminal": "终端输出",
  "prompt.mention.url": "网页内容",
  "prompt.mention.problems": "诊断问题",
  "prompt.mention.noResults": "未找到匹配项",

  // VcpStatusBadge
  "status.badge.noModel": "未选模型",
  "status.drawer.title": "运行状态与统计",
  "status.drawer.show": "显示状态详情",
  "status.drawer.hide": "隐藏状态详情",
  "status.drawer.sessionStats": "本次会话统计",
  "status.drawer.totalTokens": "已用 Tokens",
  "status.drawer.cost": "预估消耗",
  "status.drawer.recentRuns": "最近请求",
  "status.drawer.vcpBackend": "VCP 后端",
  "status.drawer.vcpConnection": "连接",
  "status.drawer.vcpConnected": "已连接",
  "status.drawer.vcpDisconnected": "未连接",
  "status.drawer.vcpUptime": "运行时间",
  "status.drawer.vcpPlugins": "活跃插件",
  "status.drawer.vcpServers": "分布式服务器",
  "status.drawer.vcpLogs": "最近日志",
  "status.action.reconnect": "刷新连接",
  "status.action.clearQueue": "清空队列",
  ...
  "prompt.toast.attachmentTooLarge.title": "附件过大",
  "prompt.toast.attachmentTooLarge.description": "{{file}} 超过 {{sizeMb}}MB 限制",
  ...
  "marketplace.tab.mcps": "MCP 服务器",
  "marketplace.search.placeholder": "搜索技能、模式或 MCP…",
  "marketplace.loading": "加载中…",
  "marketplace.empty": "暂无项目",
  "marketplace.refresh": "刷新",
  "marketplace.refresh.success": "市场数据已刷新",
  "marketplace.refresh.failed": "刷新失败",
  "marketplace.installed": "已安装",
  "marketplace.install.title": "安装 MCP 服务器",
  "marketplace.install.method": "安装方式",
  "marketplace.install.prerequisites": "前置要求",
  "marketplace.install.parameters": "参数配置",
  "marketplace.install.optional": "可选",
  "marketplace.install.cancel": "取消",
  "marketplace.install.confirm": "安装",
  ...
  "settings.aboutVCPCode.feedback.prefix": "如果您有任何问题或反馈，欢迎在以下平台提交 issue",
  "settings.aboutVCPCode.feedback.or": "或",
  "settings.aboutVCPCode.support.prefix": "如有账单或账户问题，请联系客户支持",
  ...
  "settings.autoApprove.yoloMode": "YOLO 模式",
  "settings.autoApprove.yoloMode.label": "启用 YOLO 模式 — 自动批准所有操作",
  "settings.autoApprove.yoloMode.description": "启用后，所有工具操作将自动批准，无需确认。包括文件编辑、命令执行、网页访问等所有工具。",
  "settings.autoApprove.yoloMode.warning": "⚡ YOLO 模式已启用 — 以下所有权限设置均被覆盖为「允许」",
  "settings.autoApprove.yoloMode.caution": "请谨慎使用！这将跳过所有安全确认。",
  ...
  "settings.providers.profiles.title": "配置文件",
  "settings.providers.profiles.description": "创建并切换提供商配置文件，用于快速路由不同后端。",
  "settings.providers.profiles.select": "当前配置文件",
  "settings.providers.profiles.createPlaceholder": "例如 openai-local",
  "settings.providers.profiles.create": "创建配置文件",
  "settings.providers.profiles.remove": "删除配置文件",
  "settings.providers.profile.none": "当前没有提供商配置文件，请先创建后再映射后端参数。",
  "settings.providers.profileSettings.title": "提供商 API 配置",
  "settings.providers.profileSettings.description": "将后端 provider 字段映射到该配置文件，修改会直接写入全局配置。",
  "settings.providers.apiProvider.title": "API 提供商",
  "settings.providers.apiProvider.description": "该配置文件使用的后端 provider 适配器。",
  "settings.providers.baseUrl.title": "OpenAI 基础 URL",
  "settings.providers.baseUrl.description": "OpenAI 兼容接口的请求地址。",
  "settings.providers.apiKey.title": "API 密钥",
  "settings.providers.apiKey.description": "发送到提供商请求中的 API 密钥。",
  "settings.providers.modelsPath.title": "模型路径",
  "settings.providers.modelsPath.description": "用于获取可用模型列表的相对路径。",
  "settings.providers.modelsURL.title": "模型 URL",
  "settings.providers.modelsURL.description": "用于模型发现的绝对 URL 覆盖。",
  "settings.providers.timeout.title": "请求超时（毫秒）",
  "settings.providers.timeout.description": "提供商请求超时时间，留空则使用后端默认值。",
  "settings.providers.save": "保存",
  "settings.providers.revert": "撤销",
  "settings.providers.unsaved": "当前有未保存的提供商配置变更。",
  "settings.providers.save.toast.title": "提供商配置已保存",
  "settings.providers.revert.toast.title": "已撤销未保存变更",
  "settings.providers.testConnection.title": "连接测试",
  "settings.providers.testConnection.description": "验证 Base URL 和 API Key 是否可以正常拉取模型列表。",
  "settings.providers.testConnection.button": "测试连接",
  "settings.providers.testConnection.noUrl": "请先填写 Base URL",
  "settings.providers.testConnection.success": "连接成功，已获取 {count} 个模型",
  "settings.providers.testConnection.failed": "连接失败",
  "settings.providers.advanced.title": "高级选项",
  "settings.providers.model.select": "模型",
  "settings.providers.model.selectDescription": "选择并配置该配置文件下的模型级覆盖参数。",
  "settings.providers.model.fetchingModels": "正在从提供商获取模型列表...",
  "settings.providers.model.fetchFailed": "无法获取模型列表",
  "settings.providers.model.fetchFailedHint": "模型拉取失败，请检查 URL 和 API Key，或点击「测试连接」查看详情。",
  "settings.providers.model.loading": "加载中...",
  "settings.providers.model.add": "添加自定义模型",
  "settings.providers.model.addPlaceholder": "例如 qwen/qwen3-coder",
  "settings.providers.model.removeOverride": "移除覆盖",
  "settings.providers.model.maxOutput.title": "最大输出Token数",
  "settings.providers.model.maxOutput.description": "单次响应允许生成的最大 Token 数。",
  "settings.providers.model.context.title": "上下文窗口",
  "settings.providers.model.context.description": "模型可处理的总 Token（输入 + 输出）。",
  "settings.providers.model.image.title": "图像支持",
  "settings.providers.model.image.description": "允许此模型接收图像输入。",
  "settings.providers.model.promptCache.title": "提示缓存",
  "settings.providers.model.promptCache.description": "启用提示缓存相关的 provider cache key。",
  "settings.providers.model.inputPrice.title": "输入价格",
  "settings.providers.model.inputPrice.description": "每 100 万输入 Token 的价格。",
  "settings.providers.model.outputPrice.title": "输出价格",
  "settings.providers.model.outputPrice.description": "每 100 万输出 Token 的价格。",
  "settings.providers.model.cacheReadPrice.title": "缓存读取价格",
  "settings.providers.model.cacheReadPrice.description": "每 100 万缓存读取 Token 的价格。",
  "settings.providers.model.cacheWritePrice.title": "缓存写入价格",
  "settings.providers.model.cacheWritePrice.description": "每 100 万缓存写入 Token 的价格。",
  "settings.providers.model.reasoning.title": "推理支持",
  "settings.providers.model.reasoning.description": "标记该模型支持推理能力。",
  "settings.providers.model.temperature.title": "自定义温度",
  "settings.providers.model.temperature.description": "允许该模型启用温度采样参数。",
  "settings.providers.model.toolCall.title": "工具调用",
  "settings.providers.model.toolCall.description": "允许该模型发起工具调用。",
  "settings.providers.model.r1.title": "启用 R1 参数",
  "settings.providers.model.r1.description": "为 QwQ/R1 系列启用深度推理参数。",
  "settings.providers.model.stream.title": "启用流式传输",
  "settings.providers.model.stream.description": "在支持时请求流式返回分片。",
  "settings.providers.model.includeMaxOutput.title": "包含最大输出Token参数",
  "settings.providers.model.includeMaxOutput.description": "向提供商请求发送最大输出 Token 限制。",
  "settings.providers.model.azure.title": "使用 Azure 服务",
  "settings.providers.model.azure.description": "为该模型启用 Azure 兼容路由参数。",
  "settings.providers.model.reasoningEffort.title": "推理强度",
  "settings.providers.model.reasoningEffort.description": "在 provider options 中发送默认推理强度。",
  "settings.providers.model.reasoningEffort.option.minimal": "最小",
  "settings.providers.model.reasoningEffort.option.low": "低",
  "settings.providers.model.reasoningEffort.option.medium": "中",
  "settings.providers.model.reasoningEffort.option.high": "高",
  "settings.providers.model.customHeaders.title": "自定义标头",
  "settings.providers.model.customHeaders.description": "请求该模型时附加的 HTTP 标头。",
  "settings.providers.header.keyPlaceholder": "标头名称",
  "settings.providers.header.valuePlaceholder": "标头值",
  "settings.save.toast.title": "设置已保存",
  "settings.codebaseIndex.status": "状态",
  "settings.codebaseIndex.lastUpdated": "上次更新",
  "settings.codebaseIndex.start": "开始",
  "settings.codebaseIndex.clear": "清除索引",
  "settings.codebaseIndex.refresh": "刷新状态",
  "settings.codebaseIndex.embedding.title": "嵌入模型提供商",
  "settings.codebaseIndex.embedding.testButton": "测试连接",
  "settings.codebaseIndex.embedding.testNoUrl": "请先填写嵌入模型 Base URL",
  "settings.codebaseIndex.embedding.testSuccess": "嵌入端点连接成功，可用 {count} 个模型",
  "settings.codebaseIndex.embedding.testFailed": "嵌入端点连接失败",
  "settings.codebaseIndex.embedding.testOk": "连接正常",
  "settings.codebaseIndex.vector.title": "向量存储",
  "dialog.model.notSet": "未设置",
  "profile.personalAccount": "个人账户",
  "settings.vcp.title": "VCP配置",

  // ===== VCP Settings =====
  "settings.vcp.group.basic": "VCP 基础设置",
  "settings.vcp.group.memory": "内存桥接",
  "settings.vcp.group.toolbox": "VCPToolBox",
  "settings.vcp.enabled.title": "启用 VCP 模式",
  "settings.vcp.enabled.description": "在运行时启用 VCP 协议扩展。",
  "settings.vcp.contextFold.title": "上下文折叠",
  "settings.vcp.contextFold.description": "使用可配置标记包裹可折叠的上下文块。",
  "settings.vcp.contextFold.style.title": "渲染样式",
  "settings.vcp.contextFold.style.description": "选择折叠上下文块的显示方式。",
  "settings.vcp.contextFold.startMarker.title": "起始标记",
  "settings.vcp.contextFold.startMarker.description": "插入在折叠上下文块前的标记。",
  "settings.vcp.contextFold.endMarker.title": "结束标记",
  "settings.vcp.contextFold.endMarker.description": "插入在折叠上下文块后的标记。",
  "settings.vcp.vcpInfo.title": "VCPInfo 桥接",
  "settings.vcp.vcpInfo.description": "在模型输出中暴露 VCPInfo 元数据块。",
  "settings.vcp.vcpInfo.startMarker.title": "起始标记",
  "settings.vcp.vcpInfo.startMarker.description": "插入在 VCPInfo 块前的标记。",
  "settings.vcp.vcpInfo.endMarker.title": "结束标记",
  "settings.vcp.vcpInfo.endMarker.description": "插入在 VCPInfo 块后的标记。",
  "settings.vcp.toolRequest.title": "工具请求桥接",
  "settings.vcp.toolRequest.description": "从模型输出中暴露结构化工具请求块。",
  "settings.vcp.toolRequest.bridgeMode.title": "桥接模式",
  "settings.vcp.toolRequest.bridgeMode.description": "选择直接执行工具请求或以事件形式发送。",
  "settings.vcp.toolRequest.maxPerMessage.title": "每条消息最大请求数",
  "settings.vcp.toolRequest.maxPerMessage.description": "单条消息可处理的工具请求数量上限。",
  "settings.vcp.toolRequest.allowTools.title": "允许工具",
  "settings.vcp.toolRequest.allowTools.description": "允许被请求的工具白名单（逗号分隔）。",
  "settings.vcp.toolRequest.denyTools.title": "禁止工具",
  "settings.vcp.toolRequest.denyTools.description": "始终禁止的工具黑名单（逗号分隔）。",
  "settings.vcp.toolRequest.keepInOutput.title": "在输出中保留请求块",
  "settings.vcp.toolRequest.keepInOutput.description": "在助手输出文本中保留原始工具请求块。",
  "settings.vcp.toolRequest.startMarker.title": "起始标记",
  "settings.vcp.toolRequest.startMarker.description": "工具请求块的起始标记。",
  "settings.vcp.toolRequest.endMarker.title": "结束标记",
  "settings.vcp.toolRequest.endMarker.description": "工具请求块的结束标记。",
  "settings.vcp.html.title": "HTML 渲染",
  "settings.vcp.html.description": "为兼容客户端启用 HTML 响应渲染。",
  "settings.vcp.agentTeam.title": "Agent 团队",
  "settings.vcp.agentTeam.description": "启用分布式多 Agent 协作。",
  "settings.vcp.agentTeam.maxParallel.title": "最大并行 Agent 数",
  "settings.vcp.agentTeam.maxParallel.description": "每个波次允许并行运行的 Agent 数量上限。",
  "settings.vcp.agentTeam.waveStrategy.title": "波次策略",
  "settings.vcp.agentTeam.waveStrategy.description": "用于调度多 Agent 执行波次的策略。",
  "settings.vcp.agentTeam.requireFileSeparation.title": "要求文件隔离",
  "settings.vcp.agentTeam.requireFileSeparation.description": "尽可能要求每个 Agent 处理不同文件。",
  "settings.vcp.agentTeam.handoffFormat.title": "交接格式",
  "settings.vcp.agentTeam.handoffFormat.description": "Agent 间交接摘要的首选格式。",
  "settings.vcp.memory.migratedNote": "内存运行时设置已迁移到专用的 Memory 面板。",
  "settings.vcp.toolbox.wsEnabled.title": "启用 WebSocket 连接",
  "settings.vcp.toolbox.wsEnabled.description": "启用后将通过 WebSocket 连接 VCPToolBox 获取运行时信息。",
  "settings.vcp.toolbox.wsUrl.title": "WebSocket 地址",
  "settings.vcp.toolbox.wsUrl.description": "VCPToolBox WebSocket 服务地址，例如 ws://localhost:5800。",
  "settings.vcp.toolbox.wsKey.title": "VCP 密钥",
  "settings.vcp.toolbox.wsKey.description": "用于 WebSocket 连接认证的 VCP_Key。",
  "settings.vcp.toolbox.reconnectInterval.title": "重连间隔 (ms)",
  "settings.vcp.toolbox.reconnectInterval.description": "WebSocket 断开后自动重连的间隔时间（毫秒），最小 1000。",
  "settings.vcp.enabled.toast.enabled": "VCP 模式已启用",
  "settings.vcp.enabled.toast.disabled": "VCP 模式已禁用",
  "settings.vcp.contextFold.toast.enabled": "上下文折叠已启用",
  "settings.vcp.contextFold.toast.disabled": "上下文折叠已禁用",
  "settings.vcp.vcpInfo.toast.enabled": "VCPInfo 桥接已启用",
  "settings.vcp.vcpInfo.toast.disabled": "VCPInfo 桥接已禁用",
  "settings.vcp.toolRequest.toast.enabled": "工具请求桥接已启用",
  "settings.vcp.toolRequest.toast.disabled": "工具请求桥接已禁用",
  "settings.vcp.toolRequest.keepInOutput.toast.enabled": "已在输出中保留工具请求块",
  "settings.vcp.toolRequest.keepInOutput.toast.disabled": "已停止在输出中保留工具请求块",
  "settings.vcp.html.toast.enabled": "HTML 渲染已启用",
  "settings.vcp.html.toast.disabled": "HTML 渲染已禁用",
  "settings.vcp.agentTeam.toast.enabled": "Agent 团队已启用",
  "settings.vcp.agentTeam.toast.disabled": "Agent 团队已禁用",
  "settings.vcp.agentTeam.requireFileSeparation.toast.enabled": "文件隔离要求已启用",
  "settings.vcp.agentTeam.requireFileSeparation.toast.disabled": "文件隔离要求已禁用",
}
