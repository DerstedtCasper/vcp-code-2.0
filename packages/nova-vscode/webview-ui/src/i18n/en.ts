export const dict = {
  ...
  "settings.vcp.vcptoolbox.baseUrl.description": "Base URL for VCPToolBox API.",
  "settings.vcp.vcptoolbox.modelsPath.title": "Models Path",
  "settings.vcp.vcptoolbox.modelsPath.description": "Path used to fetch the model list.",
  "settings.vcp.vcptoolbox.modelsURL.title": "Models URL",
  "settings.vcp.vcptoolbox.modelsURL.description": "Full URL override for model discovery.",
  "settings.vcp.vcptoolbox.apiKey.title": "API Key",
  "settings.vcp.vcptoolbox.apiKey.description": "API key sent to VCPToolBox requests.",
