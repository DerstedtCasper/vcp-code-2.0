export const dict = {
  ...
  "prompt.action.addContext": "Add context (@)",
  "prompt.action.codebaseIndex": "Codebase indexing",
  "prompt.action.agentBehaviour": "Agent behaviour",
  ...
  "prompt.slash.new": "New session",
  "prompt.slash.new.desc": "Start a new conversation",
  "prompt.slash.clear": "Clear session",
  "prompt.slash.clear.desc": "Clear current conversation",
  "prompt.slash.model": "Switch model",
  "prompt.slash.model.desc": "Open model selector",
  "prompt.slash.mode": "Switch mode",
  "prompt.slash.mode.desc": "Open mode switcher",
  "prompt.slash.compact": "Compact context",
  "prompt.slash.compact.desc": "Compress conversation context",
  "prompt.slash.enhance": "Enhance prompt",
  "prompt.slash.enhance.desc": "AI-enhance current input",

  // Context mentions & pills
  "prompt.mention.contextItems": "Context items",
  "prompt.mention.remove": "Remove",
  "prompt.mention.files": "Files",
  "prompt.mention.directories": "Directories",
  "prompt.mention.agents": "Agents",
  "prompt.mention.special": "Special",
  "prompt.mention.clipboard": "Clipboard content",
  "prompt.mention.git": "Git changes",
  "prompt.mention.terminal": "Terminal output",
  "prompt.mention.url": "Web page content",
  "prompt.mention.problems": "Diagnostics",
  "prompt.mention.noResults": "No results found",

  // VcpStatusBadge
  "status.badge.noModel": "No model",
  "status.drawer.title": "Status & Statistics",
  "status.drawer.show": "Show status details",
  "status.drawer.hide": "Hide status details",
  "status.drawer.sessionStats": "Session statistics",
  "status.drawer.totalTokens": "Tokens used",
  "status.drawer.cost": "Estimated cost",
  "status.drawer.recentRuns": "Recent requests",
  "status.drawer.vcpBackend": "VCP Backend",
  "status.drawer.vcpConnection": "Connection",
  "status.drawer.vcpConnected": "Connected",
  "status.drawer.vcpDisconnected": "Disconnected",
  "status.drawer.vcpUptime": "Uptime",
  "status.drawer.vcpPlugins": "Active Plugins",
  "status.drawer.vcpServers": "Distributed Servers",
  "status.drawer.vcpLogs": "Recent Logs",
  "status.action.reconnect": "Reconnect",
  "status.action.clearQueue": "Clear queue",
  ...
  "prompt.toast.attachmentTooLarge.description": "{{file}} exceeds {{sizeMb}}MB limit",
  ...
  "ui.yolo.route.approve": "YOLO auto-approved this permission",
  "ui.yolo.route.escalate": "YOLO escalated this permission for manual approval",
  "ui.yolo.confidence": "Confidence: {{value}}%",
  "ui.yolo.source": "Source: {{source}}",
  "ui.yolo.source.small_model": "Small model",
  "ui.yolo.source.heuristic": "Heuristic",
  "ui.yolo.reason": "Reason: {{reason}}",
  "ui.yolo.reasonFallback": "No reason provided",
  "ui.yolo.manualOverrideHint": "Manual controls below can override this YOLO decision.",
  ...
  "marketplace.tab.mcps": "MCP Servers",
  "marketplace.search.placeholder": "Search skills, modes, or MCPs…",
  "marketplace.loading": "Loading…",
  "marketplace.empty": "No items found",
  "marketplace.refresh": "Refresh",
  "marketplace.refresh.success": "Marketplace data refreshed",
  "marketplace.refresh.failed": "Refresh failed",
  "marketplace.installed": "Installed",
  "marketplace.install.title": "Install MCP Server",
  ...
  "marketplace.install.confirm": "Install",
  "marketplace.install.installing": "Installing…",
  "marketplace.install.success": "Installed successfully",
  ...
  "settings.aboutVCPCode.feedback.prefix": "If you have any questions or feedback, feel free to open an issue on",
  "settings.aboutVCPCode.feedback.or": "or",
  "settings.aboutVCPCode.support.prefix": "For billing or account questions, contact Customer Support at",
  ...
  "settings.providers.profiles.title": "Configuration Profiles",
  "settings.providers.profiles.description": "Create and switch provider config profiles for quick routing.",
  "settings.providers.profiles.select": "Active profile",
  "settings.providers.profiles.createPlaceholder": "e.g. openai-local",
  "settings.providers.profiles.create": "Create profile",
  "settings.providers.profiles.remove": "Delete profile",
  "settings.providers.profile.none": "No provider profile yet. Create one to map backend provider settings.",
  "settings.providers.profileSettings.title": "Provider API Configuration",
  "settings.providers.profileSettings.description":
    "Map backend provider fields to this profile. Changes are saved to global config.",
  "settings.providers.apiProvider.title": "API Provider",
  "settings.providers.apiProvider.description": "Backend provider adapter used by this profile.",
  "settings.providers.baseUrl.title": "OpenAI Base URL",
  "settings.providers.baseUrl.description": "HTTP endpoint for OpenAI-compatible APIs.",
  "settings.providers.apiKey.title": "API Key",
  "settings.providers.apiKey.description": "API key sent with provider requests.",
  "settings.providers.modelsPath.title": "Models Path",
  "settings.providers.modelsPath.description": "Relative path to fetch available models.",
  "settings.providers.modelsURL.title": "Models URL",
  "settings.providers.modelsURL.description": "Absolute URL override for model discovery.",
  "settings.providers.timeout.title": "Request Timeout (ms)",
  "settings.providers.timeout.description": "Provider request timeout in milliseconds. Empty uses backend default.",
  "settings.providers.save": "Save",
  "settings.providers.revert": "Revert",
  "settings.providers.unsaved": "You have unsaved provider changes.",
  "settings.providers.save.toast.title": "Provider settings saved",
  "settings.providers.revert.toast.title": "Unsaved changes reverted",
  "settings.providers.testConnection.title": "Test Connection",
  "settings.providers.testConnection.description": "Verify that the Base URL and API Key can successfully fetch the model list.",
  "settings.providers.testConnection.button": "Test Connection",
  "settings.providers.testConnection.noUrl": "Please enter a Base URL first",
  "settings.providers.testConnection.success": "Connection successful — {count} models available",
  "settings.providers.testConnection.failed": "Connection failed",
  "settings.providers.advanced.title": "Advanced Options",
  "settings.providers.model.select": "Model",
  "settings.providers.model.selectDescription": "Select and configure model-level overrides for this profile.",
  "settings.providers.model.fetchingModels": "Fetching model list from provider...",
  "settings.providers.model.fetchFailed": "Failed to fetch model list",
  "settings.providers.model.fetchFailedHint": "Model fetch failed. Check URL and API Key, or click \"Test Connection\" for details.",
  "settings.providers.model.loading": "Loading...",
  "settings.providers.model.add": "Add Custom Model",
  "settings.providers.model.addPlaceholder": "e.g. qwen/qwen3-coder",
  "settings.providers.model.removeOverride": "Remove override",
  "settings.providers.model.maxOutput.title": "Max Output Tokens",
  "settings.providers.model.maxOutput.description": "Maximum tokens generated in a single response.",
  "settings.providers.model.context.title": "Context Window",
  "settings.providers.model.context.description": "Total tokens the model can process (input + output).",
  "settings.providers.model.image.title": "Image Support",
  "settings.providers.model.image.description": "Allow this model to accept image inputs.",
  "settings.providers.model.promptCache.title": "Prompt Cache",
  "settings.providers.model.promptCache.description": "Enable provider cache key hints for prompt caching.",
  "settings.providers.model.inputPrice.title": "Input Price",
  "settings.providers.model.inputPrice.description": "Cost per 1M input tokens.",
  "settings.providers.model.outputPrice.title": "Output Price",
  "settings.providers.model.outputPrice.description": "Cost per 1M output tokens.",
  "settings.providers.model.cacheReadPrice.title": "Cache Read Price",
  "settings.providers.model.cacheReadPrice.description": "Cost per 1M cache read tokens.",
  "settings.providers.model.cacheWritePrice.title": "Cache Write Price",
  "settings.providers.model.cacheWritePrice.description": "Cost per 1M cache write tokens.",
  "settings.providers.model.reasoning.title": "Reasoning Support",
  "settings.providers.model.reasoning.description": "Mark this model as reasoning-capable.",
  "settings.providers.model.temperature.title": "Custom Temperature",
  "settings.providers.model.temperature.description": "Allow sampling temperature overrides for this model.",
  "settings.providers.model.toolCall.title": "Tool Calling",
  "settings.providers.model.toolCall.description": "Allow this model to call tools.",
  "settings.providers.model.r1.title": "Enable R1 Parameters",
  "settings.providers.model.r1.description": "Enable R1/deep-thinking request parameters (for QwQ/R1 families).",
  "settings.providers.model.stream.title": "Enable Streaming",
  "settings.providers.model.stream.description": "Request streaming response chunks when supported.",
  "settings.providers.model.includeMaxOutput.title": "Include Max Output Tokens",
  "settings.providers.model.includeMaxOutput.description": "Send max output token limits to the provider request.",
  "settings.providers.model.azure.title": "Use Azure Service",
  "settings.providers.model.azure.description": "Route this model through Azure-compatible options.",
  "settings.providers.model.reasoningEffort.title": "Reasoning Effort",
  "settings.providers.model.reasoningEffort.description": "Default reasoning effort sent in provider options.",
  "settings.providers.model.reasoningEffort.option.minimal": "Minimal",
  "settings.providers.model.reasoningEffort.option.low": "Low",
  "settings.providers.model.reasoningEffort.option.medium": "Medium",
  "settings.providers.model.reasoningEffort.option.high": "High",
  "settings.providers.model.customHeaders.title": "Custom Headers",
  "settings.providers.model.customHeaders.description": "Additional HTTP headers sent with this model.",
  "settings.providers.header.keyPlaceholder": "Header name",
  "settings.providers.header.valuePlaceholder": "Header value",
  "settings.save.toast.title": "Settings saved",
  "settings.codebaseIndex.status": "Status",
  "settings.codebaseIndex.lastUpdated": "Last updated",
  "settings.codebaseIndex.start": "Start",
  "settings.codebaseIndex.clear": "Clear Index",
  "settings.codebaseIndex.refresh": "Refresh",
  "settings.codebaseIndex.embedding.title": "Embedding Provider",
  "settings.codebaseIndex.embedding.testButton": "Test Connection",
  "settings.codebaseIndex.embedding.testNoUrl": "Please enter an Embedding Base URL first",
  "settings.codebaseIndex.embedding.testSuccess": "Embedding endpoint connected — {count} models available",
  "settings.codebaseIndex.embedding.testFailed": "Embedding endpoint connection failed",
  "settings.codebaseIndex.embedding.testOk": "Connected",
  "settings.codebaseIndex.vector.title": "Vector Store",

  "dialog.model.notSet": "Not set",

  "profile.personalAccount": "Personal Account",
  "settings.vcp.title": "VCP Configuration",

  // ===== VCP Settings =====
  "settings.vcp.group.basic": "Basic VCP Settings",
  "settings.vcp.group.memory": "Memory Bridge",
  "settings.vcp.group.toolbox": "VCPToolBox",
  "settings.vcp.enabled.title": "Enable VCP Mode",
  "settings.vcp.enabled.description": "Enable VCP protocol extensions in the runtime.",
  "settings.vcp.contextFold.title": "Context Fold",
  "settings.vcp.contextFold.description": "Wrap foldable context blocks with configurable markers.",
  "settings.vcp.contextFold.style.title": "Render Style",
  "settings.vcp.contextFold.style.description": "Choose how folded context blocks are rendered.",
  "settings.vcp.contextFold.startMarker.title": "Start Marker",
  "settings.vcp.contextFold.startMarker.description": "Marker inserted before a folded context block.",
  "settings.vcp.contextFold.endMarker.title": "End Marker",
  "settings.vcp.contextFold.endMarker.description": "Marker inserted after a folded context block.",
  "settings.vcp.vcpInfo.title": "VCPInfo Bridge",
  "settings.vcp.vcpInfo.description": "Expose VCPInfo metadata blocks in model output.",
  "settings.vcp.vcpInfo.startMarker.title": "Start Marker",
  "settings.vcp.vcpInfo.startMarker.description": "Marker inserted before a VCPInfo block.",
  "settings.vcp.vcpInfo.endMarker.title": "End Marker",
  "settings.vcp.vcpInfo.endMarker.description": "Marker inserted after a VCPInfo block.",
  "settings.vcp.toolRequest.title": "Tool Request Bridge",
  "settings.vcp.toolRequest.description": "Expose structured tool request blocks from model output.",
  "settings.vcp.toolRequest.bridgeMode.title": "Bridge Mode",
  "settings.vcp.toolRequest.bridgeMode.description": "Choose whether tool requests are executed directly or posted as events.",
  "settings.vcp.toolRequest.maxPerMessage.title": "Max Requests Per Message",
  "settings.vcp.toolRequest.maxPerMessage.description": "Maximum number of tool requests processed from a single message.",
  "settings.vcp.toolRequest.allowTools.title": "Allowed Tools",
  "settings.vcp.toolRequest.allowTools.description": "Comma-separated allowlist of tools that can be requested.",
  "settings.vcp.toolRequest.denyTools.title": "Blocked Tools",
  "settings.vcp.toolRequest.denyTools.description": "Comma-separated denylist of tools that are always blocked.",
  "settings.vcp.toolRequest.keepInOutput.title": "Keep Blocks in Output",
  "settings.vcp.toolRequest.keepInOutput.description": "Keep raw tool request blocks in assistant output text.",
  "settings.vcp.toolRequest.startMarker.title": "Start Marker",
  "settings.vcp.toolRequest.startMarker.description": "Marker inserted before a tool request block.",
  "settings.vcp.toolRequest.endMarker.title": "End Marker",
  "settings.vcp.toolRequest.endMarker.description": "Marker inserted after a tool request block.",
  "settings.vcp.html.title": "HTML Rendering",
  "settings.vcp.html.description": "Enable HTML response rendering for compatible clients.",
  "settings.vcp.agentTeam.title": "Agent Team",
  "settings.vcp.agentTeam.description": "Enable distributed multi-agent coordination.",
  "settings.vcp.agentTeam.maxParallel.title": "Max Parallel Agents",
  "settings.vcp.agentTeam.maxParallel.description": "Maximum number of agents allowed to run in parallel per wave.",
  "settings.vcp.agentTeam.waveStrategy.title": "Wave Strategy",
  "settings.vcp.agentTeam.waveStrategy.description": "Strategy for scheduling multi-agent execution waves.",
  "settings.vcp.agentTeam.requireFileSeparation.title": "Require File Separation",
  "settings.vcp.agentTeam.requireFileSeparation.description": "Require each agent to work on distinct files when possible.",
  "settings.vcp.agentTeam.handoffFormat.title": "Handoff Format",
  "settings.vcp.agentTeam.handoffFormat.description": "Preferred format for inter-agent handoff summaries.",
  "settings.vcp.memory.migratedNote": "Memory runtime settings moved to the dedicated Memory panel.",
  "settings.vcp.toolbox.wsEnabled.title": "Enable WebSocket Connection",
  "settings.vcp.toolbox.wsEnabled.description": "Enable WebSocket connection to VCPToolBox for runtime info.",
  "settings.vcp.toolbox.wsUrl.title": "WebSocket URL",
  "settings.vcp.toolbox.wsUrl.description": "VCPToolBox WebSocket server URL, e.g. ws://localhost:5800.",
  "settings.vcp.toolbox.wsKey.title": "VCP Key",
  "settings.vcp.toolbox.wsKey.description": "VCP_Key for WebSocket authentication.",
  "settings.vcp.toolbox.reconnectInterval.title": "Reconnect Interval (ms)",
  "settings.vcp.toolbox.reconnectInterval.description": "Auto-reconnect interval after WebSocket disconnection (milliseconds), minimum 1000.",
  "settings.vcp.enabled.toast.enabled": "VCP mode enabled",
  "settings.vcp.enabled.toast.disabled": "VCP mode disabled",
  "settings.vcp.contextFold.toast.enabled": "Context Fold enabled",
  "settings.vcp.contextFold.toast.disabled": "Context Fold disabled",
  "settings.vcp.vcpInfo.toast.enabled": "VCPInfo bridge enabled",
  "settings.vcp.vcpInfo.toast.disabled": "VCPInfo bridge disabled",
  "settings.vcp.toolRequest.toast.enabled": "Tool Request bridge enabled",
  "settings.vcp.toolRequest.toast.disabled": "Tool Request bridge disabled",
  "settings.vcp.toolRequest.keepInOutput.toast.enabled": "Tool request blocks will be kept in output",
  "settings.vcp.toolRequest.keepInOutput.toast.disabled": "Tool request blocks will be hidden from output",
  "settings.vcp.html.toast.enabled": "HTML rendering enabled",
  "settings.vcp.html.toast.disabled": "HTML rendering disabled",
  "settings.vcp.agentTeam.toast.enabled": "Agent Team enabled",
  "settings.vcp.agentTeam.toast.disabled": "Agent Team disabled",
  "settings.vcp.agentTeam.requireFileSeparation.toast.enabled": "File separation requirement enabled",
  "settings.vcp.agentTeam.requireFileSeparation.toast.disabled": "File separation requirement disabled",
}
