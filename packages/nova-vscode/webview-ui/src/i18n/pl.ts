export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez Nova",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Nova.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w Nova.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w Nova.",
  ...
  "dialog.server.description": "Przełącz serwer Nova, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja Nova ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu Nova",
  ...
  "error.chain.mcpFailed":
    'Serwer MCP "{{name}}" nie powiódł się. Uwaga, Nova nie obsługuje jeszcze uwierzytelniania MCP.',
  ...
  "sidebar.gettingStarted.line1": "Nova zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla Nova",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd Nova na swoim urządzeniu",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw Nova.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania Nova",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji Nova.",
  ...
  "deviceAuth.title": "Zaloguj się do VCP Code",
  ...
  "profile.action.login": "Zaloguj się przez VCP Code",
  ...
  "settings.aboutVCPCode.title": "O VCP Code",

  "session.messages.empty": "Rozpocznij rozmowę, wpisując wiadomość poniżej.",
  "session.messages.welcome":
    "VCP Code to asystent programowania AI. Poproś go o tworzenie funkcji, naprawę błędów lub wyjaśnienie bazy kodu.",
  ...
  "settings.aboutVCPCode.status.connected": "Połączono",
  "settings.aboutVCPCode.status.connecting": "Łączenie...",
  "settings.aboutVCPCode.status.disconnected": "Rozłączono",
  "settings.aboutVCPCode.status.error": "Błąd",
  "settings.aboutVCPCode.cliServer": "Serwer CLI",
  "settings.aboutVCPCode.status.label": "Status:",
  "settings.aboutVCPCode.port.label": "Port:",
  "settings.aboutVCPCode.versionInfo": "Informacje o wersji",
  "settings.aboutVCPCode.version.label": "Wersja:",
  "settings.aboutVCPCode.extensionName": "Rozszerzenie VCP Code",
  "settings.aboutVCPCode.community": "Społeczność i wsparcie",
  "settings.aboutVCPCode.feedback.prefix": "Jeśli masz pytania lub uwagi, śmiało otwórz zgłoszenie na",
  "settings.aboutVCPCode.feedback.or": "lub",
  "settings.aboutVCPCode.support.prefix":
    "W sprawach rozliczeń lub konta skontaktuj się z obsługą klienta pod adresem",
  "settings.aboutVCPCode.resetSettings.title": "Resetuj ustawienia",
  "settings.aboutVCPCode.resetSettings.description":
    "Zresetuj wszystkie ustawienia rozszerzenia VCP Code do wartości domyślnych. Nie wpływa to na konfigurację CLI ani backendu.",
  "settings.aboutVCPCode.resetSettings.button": "Resetuj wszystkie ustawienia",
  ...
  "settings.language.description": 'Wybierz język interfejsu VCP Code. „Auto" używa języka wyświetlania VS Code.',
