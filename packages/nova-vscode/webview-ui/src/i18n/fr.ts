export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par Nova",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans Nova.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans Nova.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans Nova.",
  ...
  "dialog.server.description": "Changez le serveur Nova auquel cette application se connecte.",
  ...
  "toast.update.description": "Une nouvelle version d'Nova ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe Nova",
  ...
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'Nova ne supporte pas encore l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1": "Nova inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour Nova",
  "settings.general.row.appearance.title": "Apparence",
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'Nova sur votre appareil",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'Nova.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'Nova",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'Nova.",
  ...
  "deviceAuth.title": "Se connecter à VCP Code",
  ...
  "profile.action.login": "Se connecter avec VCP Code",
  ...
  "settings.aboutVCPCode.title": "À propos de VCP Code",

  "session.messages.empty": "Commencez une conversation en tapant un message ci-dessous.",
  "session.messages.welcome":
    "VCP Code est un assistant de programmation IA. Demandez-lui de créer des fonctionnalités, corriger des bugs ou expliquer votre code.",
  ...
  "settings.aboutVCPCode.status.connected": "Connecté",
  "settings.aboutVCPCode.status.connecting": "Connexion en cours...",
  "settings.aboutVCPCode.status.disconnected": "Déconnecté",
  "settings.aboutVCPCode.status.error": "Erreur",
  "settings.aboutVCPCode.cliServer": "Serveur CLI",
  "settings.aboutVCPCode.status.label": "Statut :",
  "settings.aboutVCPCode.port.label": "Port :",
  "settings.aboutVCPCode.versionInfo": "Informations de version",
  "settings.aboutVCPCode.version.label": "Version :",
  "settings.aboutVCPCode.extensionName": "Extension VCP Code",
  "settings.aboutVCPCode.community": "Communauté et support",
  ...
  "settings.aboutVCPCode.resetSettings.title": "Réinitialiser les paramètres",
  "settings.aboutVCPCode.resetSettings.description":
    "Réinitialiser tous les paramètres de l'extension VCP Code à leurs valeurs par défaut. Cela n'affecte pas la configuration CLI ou backend.",
  "settings.aboutVCPCode.resetSettings.button": "Réinitialiser tous les paramètres",
  ...
  "settings.language.description":
    "Choisissez la langue de l'interface de VCP Code. \"Auto\" utilise la langue d'affichage de VS Code.",
