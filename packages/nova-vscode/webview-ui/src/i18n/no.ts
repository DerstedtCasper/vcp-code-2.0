...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av Nova",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i Nova.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Nova.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Nova.",
  ...
  "dialog.server.description": "Bytt hvilken Nova-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Nova ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Nova-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Nova ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "Nova inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Nova",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Nova ser ut på enheten din",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan Nova er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Nova starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Nova.",
  ...
  "deviceAuth.title": "Logg inn på VCP Code",
  ...
  "profile.action.login": "Logg inn med VCP Code",
  ...
  "session.messages.welcome":
    "VCP Code er en AI-kodingsassistent. Be den om å bygge funksjoner, fikse feil eller forklare kodebasen din.",
  ...
  "settings.language.description": 'Velg språket for VCP Code-grensesnittet. "Auto" bruker VS Codes visningsspråk.',
