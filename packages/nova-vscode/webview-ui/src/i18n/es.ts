export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por Nova",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en Nova.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en Nova.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en Nova.",
  ...
  "dialog.server.description": "Cambiar a qué servidor de Nova se conecta esta app.",
  ...
  "toast.update.description": "Una nueva versión de Nova ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de Nova",
  ...
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, Nova no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "Nova incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para Nova",
  "settings.general.row.appearance.title": "Apariencia",
  "settings.general.row.appearance.description": "Personaliza cómo se ve Nova en tu dispositivo",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de Nova.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia Nova",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de Nova.",
  ...
  "deviceAuth.title": "Iniciar sesión en VCP Code",
  ...
  "profile.action.login": "Iniciar sesión con VCP Code",
  ...
  "settings.aboutVCPCode.title": "Acerca de VCP Code",

  "session.messages.empty": "Inicia una conversación escribiendo un mensaje a continuación.",
  "session.messages.welcome":
    "VCP Code es un asistente de programación con IA. Pídele que cree funcionalidades, corrija errores o explique tu código.",
  ...
  "settings.aboutVCPCode.status.label": "Estado:",
  "settings.aboutVCPCode.port.label": "Puerto:",
  "settings.aboutVCPCode.versionInfo": "Información de versión",
  "settings.aboutVCPCode.version.label": "Versión:",
  "settings.aboutVCPCode.extensionName": "Extensión VCP Code",
  "settings.aboutVCPCode.community": "Comunidad y soporte",
  "settings.aboutVCPCode.feedback.prefix": "Si tienes preguntas o comentarios, abre un issue en",
  "settings.aboutVCPCode.feedback.or": "o",
  "settings.aboutVCPCode.support.prefix": "Para preguntas de facturación o cuenta, contacta al Soporte al Cliente en",
  "settings.aboutVCPCode.resetSettings.title": "Restablecer configuración",
  "settings.aboutVCPCode.resetSettings.description":
    "Restablecer todas las configuraciones de la extensión VCP Code a sus valores predeterminados. Esto no afecta la configuración del CLI o del backend.",
  "settings.aboutVCPCode.resetSettings.button": "Restablecer toda la configuración",
  ...
  "settings.language.description":
    'Elige el idioma de la interfaz de VCP Code. "Auto" utiliza el idioma de visualización de VS Code.',
