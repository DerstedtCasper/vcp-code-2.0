...
export const NOVA_GATEWAY_ID = "kilo"

export const PROVIDER_ORDER = [NOVA_GATEWAY_ID, "anthropic", "openai", "google"]
...
export function buildTriggerLabel(
  ...
  if (raw?.providerID && raw?.modelID) {
    return raw.providerID === NOVA_GATEWAY_ID ? raw.modelID : `${raw.providerID} / ${raw.modelID}`
  }
