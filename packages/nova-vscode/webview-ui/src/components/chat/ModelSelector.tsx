...
import { NOVA_GATEWAY_ID, providerSortKey, isFree, buildTriggerLabel } from "./model-selector-utils"
...
export const ModelSelectorBase: Component<ModelSelectorBaseProps> = (props) => {
  ...
  // Only show models from Nova Gateway or connected providers
  const visibleModels = createMemo(() => {
    const c = connected()
    return models().filter((m) => m.providerID === NOVA_GATEWAY_ID || c.includes(m.providerID))
  })
