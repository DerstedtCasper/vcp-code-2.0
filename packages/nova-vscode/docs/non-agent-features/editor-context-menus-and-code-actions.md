...
Full spec of the VS Code-native menu, command, code action, keyboard shortcut, and prompt template system from the old Nova Code extension. All of these need to be rebuilt in the new extension.
...
- A **"Nova Code" submenu** in the editor right-click context menu
- A **"Nova Code" submenu** in the terminal right-click context menu
...
Right-clicking in the editor shows a "Nova Code" submenu with these commands:
...
Right-clicking in the terminal shows a "Nova Code" submenu:
...
| ------------------------------ | --------------------------------------------------- |
| Always                         | **Add to Nova Code** → triggers `addToContext`      |
| Diagnostics in selection range | **Fix with Nova Code** → triggers `fixCode`         |
| No diagnostics                 | **Explain with Nova Code** → triggers `explainCode` |
| No diagnostics                 | **Improve with Nova Code** → triggers `improveCode` |
...
- `submenus`: Define "Nova Code" submenus for editor and terminal contexts
...
- **View title bar buttons**: ✅ Done ([#181](https://github.com/Kilo-Org/novacode/issues/181))
