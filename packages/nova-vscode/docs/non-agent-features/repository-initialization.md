...
Support for the `/init` command — initialize a repository for agentic engineering. This sets up the project with appropriate configuration files, rules, and conventions for working with Nova Code.

## Requirements

- Command or button to initialize a repository
- Creates appropriate configuration files (e.g., AGENTS.md, .novacode/ directory)
