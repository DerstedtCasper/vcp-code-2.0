// Session types from @novacode/cli
...
export interface NovacodeNotification {
  id: string
  title: string
  message: string
  action?: NovacodeNotificationAction
  showIn?: string[]
}

// Profile types from nova-gateway
export interface NovacodeOrganization {
  id: string
  name: string
  role: string
}

export interface NovacodeProfile {
  email: string
  name?: string
  organizations?: NovacodeOrganization[]
}

export interface NovacodeBalance {
  balance: number
}
