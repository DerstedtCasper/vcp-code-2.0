...
const SUPPORTED_PROVIDER_DISPLAY_NAME = "Nova Gateway"
...
export class AutocompleteStatusBar {
  ...
  private renderNoUsableProviderError() {
    this.statusBar.text = t("novacode:autocomplete.statusBar.warning")
    this.statusBar.tooltip = this.createMarkdownTooltip(
      t("novacode:autocomplete.statusBar.tooltip.noUsableProvider", { providers: SUPPORTED_PROVIDER_DISPLAY_NAME }),
    )
  }
}
