...
originating from the "Nova Code" layer (not the continuedev fork).
...
| `AutocompleteJetbrainsBridge.ts`                                | `../../core/novacode/wrapper`                  | `{ getNovaCodeWrapperProperties }` |
...
| `AutocompleteModel.ts`                | `../../api/providers/novacode-openrouter` | `{ NovacodeOpenrouterHandler }`               |
...
| Source File                             | Module Path                                             | Symbols                  |
| --------------------------------------- | ------------------------------------------------------- | ------------------------ |
| `continuedev/core/llm/llms/NovaCode.ts` | `../../../../../../shared/novacode/headers`             | `{ X_KILOCODE_VERSION }` |
| `continuedev/core/llm/llms/NovaCode.ts` | `../../../../../../shared/package`                      | `{ Package }`            |
| `continuedev/core/llm/llms/NovaCode.ts` | `../../../../../../api/providers/novacode/IFimProvider` | `{ IFimProvider }`       |
...
| `utils/novacode-utils.ts`                                       | `{ getKiloBaseUriFromToken, AUTOCOMPLETE_PROVIDER_MODELS, AutocompleteProviderKey }` |
| `continuedev/core/llm/llms/NovaCode.ts`                         | `{ getKiloUrlFromToken }`                                                            |
...
src/api/providers/novacode-openrouter      (../../api/providers/novacode-openrouter)
src/api/providers/novacode/IFimProvider    (via continuedev NovaCode.ts)
...
src/core/novacode/wrapper                  (../../core/novacode/wrapper)
...
src/shared/novacode/headers                (via continuedev NovaCode.ts)
src/shared/package                         (via continuedev NovaCode.ts)
