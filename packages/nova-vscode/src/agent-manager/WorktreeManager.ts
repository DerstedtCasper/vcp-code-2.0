 ...
 *
 * Ported from novacode/src/core/novacode/agent-manager/WorktreeManager.ts.
 * Handles creation, discovery, and cleanup of worktrees stored in
 * {projectRoot}/.novacode/worktrees/
 */
