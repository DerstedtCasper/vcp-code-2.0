...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "VCP 提供的免費模型",
  ...
  "provider.connect.apiKey.description":
    "輸入你的 {{provider}} API 金鑰以連線帳戶，並在 VCP 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 取得授權碼，以連線你的帳戶並在 VCP 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 並輸入以下程式碼，以連線你的帳戶並在 VCP 中使用 {{provider}} 模型。",
  ...
  "dialog.server.description": "切換此應用程式連線的 VCP 伺服器。",
  ...
  "toast.update.description": "VCP 有新版本 ({{version}}) 可安裝。",
  ...
  "error.page.report.prefix": "請將此錯誤回報給 VCP 團隊",
  ...
  "error.chain.mcpFailed": 'MCP 伺服器 "{{name}}" 啟動失敗。注意: VCP 暫不支援 MCP 認證。',
  ...
  "sidebar.gettingStarted.line1": "VCP 提供免費模型，你可以立即開始使用。",
  ...
  "settings.general.row.language.description": "變更 VCP 的顯示語言",
  "settings.general.row.appearance.title": "外觀",
  "settings.general.row.appearance.description": "自訂 VCP 在你的裝置上的外觀",
  "settings.general.row.theme.title": "主題",
  "settings.general.row.theme.description": "自訂 VCP 的主題。",
  ...
  "settings.updates.row.startup.description": "在 VCP 啟動時自動檢查更新",
  ...
  "profile.action.login": "使用 VCP Code 登入",
  "profile.balance.title": "餘額",
  "profile.balance.refresh": "重新整理餘額",
  "profile.action.dashboard": "控制面板",
  "profile.action.logout": "登出",
  "view.marketplace.title": "市集",
  "vcp.view.status.enabled": "已啟用",
  "vcp.view.status.disabled": "已停用",
  "vcp.view.title": "VCP 控制中心",
  "vcp.view.description": "集中顯示 VCP 協議橋接、佇列運行態與診斷資訊。",
  "vcp.view.protocol.title": "協議橋接",
  "vcp.view.protocol.contextFold": "上下文摺疊",
  "vcp.view.protocol.vcpInfo": "VCP 資訊",
  "vcp.view.protocol.toolRequest": "工具請求橋接",
  "vcp.view.protocol.htmlRender": "HTML 渲染",
  "vcp.view.protocol.agentTeam": "Agent Team",
  "vcp.view.protocol.memoryRuntime": "記憶運行時",
  "vcp.view.runtime.title": "分散式運行態",
  "vcp.view.runtime.activeSession": "作用中工作階段",
  "vcp.view.runtime.sessionStatus": "工作階段狀態",
  "vcp.view.runtime.queuedPrompts": "佇列提示數",
  "vcp.view.runtime.pendingPermissions": "待處理權限",
  "vcp.view.runtime.pendingQuestions": "待處理問題",
  "vcp.view.diagnostics.title": "診斷",
  "vcp.view.diagnostics.connection": "連線",
  "vcp.view.diagnostics.serverPort": "伺服器連接埠",
  "vcp.view.diagnostics.extensionVersion": "擴充功能版本",
  "vcp.view.diagnostics.error": "錯誤",
  "vcp.view.visualization.title": "VCP 運行態可視化",
  "vcp.view.visualization.foldBlocks": "動態摺疊區塊",
  "vcp.view.visualization.vcpInfoBlocks": "VCPInfo 區塊",
  "vcp.view.visualization.toolRequestBlocks": "工具請求區塊",
  "vcp.view.observability.title": "WindowSensor / ScreenPilot 觀測",
  "vcp.view.observability.windowSensorCalls": "WindowSensor 呼叫次數",
  "vcp.view.observability.screenPilotCalls": "ScreenPilot 呼叫次數",
  "vcp.view.observability.browserAutomation": "瀏覽器自動化",
  ...
  "settings.aboutVCPCode.title": "關於 VCP Code",

  "session.messages.empty": "在下方輸入訊息以開始對話。",
  "session.messages.welcome": "VCP Code 是一個 AI 程式設計助手。讓它幫你建構功能、修復 bug 或解釋程式碼庫。",
  ...
  "settings.aboutVCPCode.status.connected": "已連線",
  "settings.aboutVCPCode.status.connecting": "連線中...",
  "settings.aboutVCPCode.status.disconnected": "已中斷",
  "settings.aboutVCPCode.status.error": "錯誤",
  "settings.aboutVCPCode.cliServer": "CLI 伺服器",
  "settings.aboutVCPCode.status.label": "狀態：",
  "settings.aboutVCPCode.port.label": "連接埠：",
  "settings.aboutVCPCode.versionInfo": "版本資訊",
  "settings.aboutVCPCode.version.label": "版本：",
  "settings.aboutVCPCode.extensionName": "VCP Code 擴充功能",
  "settings.aboutVCPCode.community": "社群與支援",
  "settings.aboutVCPCode.feedback.prefix": "如果您有任何問題或回饋，歡迎在以下平台提交 issue",
  "settings.aboutVCPCode.feedback.or": "或",
  "settings.aboutVCPCode.support.prefix": "如有帳單或帳戶問題，請聯繫客戶支援",
  "settings.aboutVCPCode.resetSettings.title": "重置設定",
  "settings.aboutVCPCode.resetSettings.description":
    "將所有 VCP Code 擴充功能設定重置為預設值。這不會影響 CLI 或後端配置。",
  "settings.aboutVCPCode.resetSettings.button": "重置所有設定",
  ...
  "settings.language.description": "選擇 VCP Code 介面的語言。「自動」使用 VS Code 的顯示語言。",
