...
export const dict = {
  ...
  "vcp.view.runtime.actions.viewQueue": "查看会话队列",
  "vcp.view.runtime.actions.clearQueue": "清空队列",
  "vcp.view.runtime.actions.queueCleared.title": "队列已清空",
  "vcp.view.runtime.actions.queueCleared.description": "当前会话的排队提示已全部移除。",
  ...
  "vcp.view.diagnostics.actions.refresh": "刷新诊断",
  "vcp.view.diagnostics.actions.export": "导出日志",
  "vcp.view.diagnostics.actions.refreshed.title": "诊断已刷新",
  "vcp.view.diagnostics.actions.refreshed.description": "已重新拉取会话与 Provider 状态。",
  "vcp.view.diagnostics.actions.export.success.title": "日志已复制",
  "vcp.view.diagnostics.actions.export.success.description": "诊断快照已复制到剪贴板。",
  "vcp.view.diagnostics.actions.export.failed.title": "导出失败",
  "vcp.view.diagnostics.actions.export.failed.description": "无法写入剪贴板，请稍后重试。",
  "vcp.view.action.configure": "配置",
  ...
  "settings.aboutVCPCode.title": "关于 VCP Code",
  ...
  "settings.aboutVCPCode.status.connected": "已连接",
  "settings.aboutVCPCode.status.connecting": "连接中...",
  "settings.aboutVCPCode.status.disconnected": "已断开",
  "settings.aboutVCPCode.status.error": "错误",
  "settings.aboutVCPCode.cliServer": "CLI 服务器",
  "settings.aboutVCPCode.status.label": "状态：",
  "settings.aboutVCPCode.port.label": "端口：",
  "settings.aboutVCPCode.versionInfo": "版本信息",
  "settings.aboutVCPCode.version.label": "版本：",
  "settings.aboutVCPCode.extensionName": "VCP Code 扩展",
  "settings.aboutVCPCode.community": "社区与支持",
  "settings.aboutVCPCode.feedback.prefix": "如果您有任何问题或反馈，欢迎访问",
  "settings.aboutVCPCode.feedback.or": "或",
  "settings.aboutVCPCode.support.prefix": "如有支持或账户问题，请在以下地址提交 issue",
  "settings.aboutVCPCode.resetSettings.title": "重置设置",
  "settings.aboutVCPCode.resetSettings.description":
    "将所有 VCP Code 扩展设置重置为默认值。这不会影响 CLI 或后端配置。",
  "settings.aboutVCPCode.resetSettings.button": "重置所有设置",
  ...
  "settings.experimental.toolToggle.title": "工具：{{name}}",
  "settings.experimental.toolToggle.description": "在当前工作区启用或禁用此工具。",
  ...
  "settings.providers.custom.description": "OpenAI 兼容提供商",
  "settings.provider.profiles.title": "配置文件",
  "settings.provider.profiles.description": "保存多组 API 配置便于快速切换。",
  "settings.provider.profiles.empty": "暂无可编辑配置文件，点击 + 新建。",
  "settings.provider.config.title": "提供商配置",
  "settings.provider.type.title": "API 提供商",
  "settings.provider.type.description": "选择适配器类型。",
  "settings.provider.displayName.title": "显示名称",
  "settings.provider.displayName.description": "该配置在列表中的名称。",
  "settings.provider.baseUrl.title": "OpenAI 基础 URL",
  "settings.provider.baseUrl.description": "OpenAI 兼容 API 地址。",
  "settings.provider.apiKey.title": "API 密钥",
  "settings.provider.apiKey.description": "用于访问提供商。",
  "settings.provider.model.title": "模型",
  "settings.provider.model.description": "优先使用下拉选择，无法枚举时可手动输入。",
  "settings.provider.fetchModels": "获取模型列表",
  "settings.provider.contextWindowLabel": "上下文窗口",
  "settings.provider.modelName.title": "模型显示名",
  "settings.provider.modelName.description": "可自定义展示文案。",
  "settings.provider.stream.title": "启用流式传输",
  "settings.provider.stream.description": "对应 options.stream。",
  "settings.provider.includeMaxTokens.title": "包含最大输出 Token 数",
  "settings.provider.includeMaxTokens.description": "对应 options.includeMaxTokens。",
  "settings.provider.useAzure.title": "启用 Azure 服务",
  "settings.provider.useAzure.description": "对应 options.useAzure。",
  "settings.provider.azureApiVersion.title": "Azure API 版本",
  "settings.provider.azureApiVersion.description": "对应 options.azureApiVersion。",
  "settings.provider.reasoningEffort.title": "模型推理强度",
  "settings.provider.reasoningEffort.description": "对应 options.reasoningEffort。",
  "settings.provider.maxOutputTokens.title": "最大输出 Token 数",
  "settings.provider.maxOutputTokens.description": "对应 options.maxOutputTokens。",
  "settings.provider.contextWindow.title": "上下文窗口大小",
  "settings.provider.contextWindow.description": "对应 options.contextWindow。",
  "settings.provider.headers.title": "自定义标头",
  "settings.provider.headers.description": "附加 Header（可选）。",
  "settings.provider.source": "来源",
  "settings.provider.advancedFilter": "高级筛选",
  "settings.unsavedChanges": "存在未保存修改",
  "toast.config.saved": "配置已保存",
  "toast.config.saveFailed": "配置保存失败",
  "toast.config.discarded.title": "已撤销未保存修改",
  "toast.config.discarded.description": "已恢复到最近一次保存的配置。",
  "toast.models.refreshed.title": "模型列表已刷新",
  "toast.models.refreshed.description": "已重新拉取 Provider 模型列表。",
  "toast.agentTeam.enabled.title": "已启用 Agent Team",
  "toast.agentTeam.enabled.description": "当前会话将使用多智能体协同编排。",
  "toast.agentTeam.disabled.title": "已退出 Agent Team",
  "toast.agentTeam.disabled.description": "已切换回 {{mode}} 模式。",
  "settings.vcp.enabled.title": "启用 VCP 兼容层",
  "settings.vcp.enabled.description": "VCP 解析与渲染总开关。",
  "settings.vcp.contextFold.title": "上下文折叠",
  "settings.vcp.contextFold.description": "解析并渲染 VCP_DYNAMIC_FOLD 块。",
  "settings.vcp.contextFold.style.title": "折叠样式",
  "settings.vcp.contextFold.style.description": "选择折叠块渲染样式。",
  "settings.vcp.contextFold.startMarker.title": "折叠开始标记",
  "settings.vcp.contextFold.startMarker.description": "检测折叠块开始的标记字符串。",
  "settings.vcp.contextFold.endMarker.title": "折叠结束标记",
  "settings.vcp.contextFold.endMarker.description": "检测折叠块结束的标记字符串。",
  "settings.vcp.vcpInfo.title": "VCPInfo",
  "settings.vcp.vcpInfo.description": "提取 VCPINFO 块并发送通知。",
  "settings.vcp.vcpInfo.startMarker.title": "VCPInfo 开始标记",
  "settings.vcp.vcpInfo.startMarker.description": "检测 VCPInfo 块开始的标记字符串。",
  "settings.vcp.vcpInfo.endMarker.title": "VCPInfo 结束标记",
  "settings.vcp.vcpInfo.endMarker.description": "检测 VCPInfo 块结束的标记字符串。",
  "settings.vcp.toolRequest.title": "TOOL_REQUEST 桥接",
  "settings.vcp.toolRequest.description": "解析 TOOL_REQUEST 协议块并桥接事件。",
  "settings.vcp.toolRequest.bridgeMode.title": "桥接模式",
  "settings.vcp.toolRequest.bridgeMode.description": "选择执行工具或仅发送事件。",
  "settings.vcp.toolRequest.maxPerMessage.title": "单消息最大请求数",
  "settings.vcp.toolRequest.maxPerMessage.description": "自动执行 TOOL_REQUEST 的安全上限。",
  "settings.vcp.toolRequest.allowTools.title": "允许工具列表",
  "settings.vcp.toolRequest.allowTools.description": "逗号分隔白名单。留空表示除拒绝列表外全部允许。",
  "settings.vcp.toolRequest.denyTools.title": "拒绝工具列表",
  "settings.vcp.toolRequest.denyTools.description": "逗号分隔黑名单，优先级高于允许列表。",
  "settings.vcp.toolRequest.keepInOutput.title": "在输出保留请求块",
  "settings.vcp.toolRequest.keepInOutput.description": "保留 TOOL_REQUEST 块在助手输出中可见。",
  "settings.vcp.toolRequest.startMarker.title": "TOOL_REQUEST 开始标记",
  "settings.vcp.toolRequest.startMarker.description": "检测 TOOL_REQUEST 块开始的标记字符串。",
  "settings.vcp.toolRequest.endMarker.title": "TOOL_REQUEST 结束标记",
  "settings.vcp.toolRequest.endMarker.description": "检测 TOOL_REQUEST 块结束的标记字符串。",
  "settings.vcp.html.title": "允许 HTML 渲染",
  "settings.vcp.html.description": "关闭后会转义助手输出中的原始 HTML。",
  "settings.vcp.agentTeam.title": "Agent Team",
  "settings.vcp.agentTeam.description": "启用编排波次策略与协作元数据提示。",
  "settings.vcp.agentTeam.maxParallel.title": "最大并行数",
  "settings.vcp.agentTeam.maxParallel.description": "每一波允许的最大子任务数量。",
  "settings.vcp.agentTeam.waveStrategy.title": "波次策略",
  "settings.vcp.agentTeam.waveStrategy.description": "编排任务的波次调度策略。",
  "settings.vcp.agentTeam.requireFileSeparation.title": "要求文件分离",
  "settings.vcp.agentTeam.requireFileSeparation.description": "仅当涉及文件不重叠时允许并行。",
  "settings.vcp.agentTeam.handoffFormat.title": "交接格式",
  "settings.vcp.agentTeam.handoffFormat.description": "任务委派摘要的首选格式。",
  "settings.vcp.memory.sectionTitle": "记忆设置",
  "settings.vcp.memory.migratedNote": "Memory 配置已迁移到设置 > 上下文页签。此处只读，避免多入口重复写入。",
  "settings.vcp.vcptoolbox.sectionTitle": "VCPToolBox 提供商",
  "settings.vcp.vcptoolbox.baseUrl.title": "基础 URL",
  "settings.vcp.vcptoolbox.baseUrl.description": "Provider API 基础地址。",
  "settings.vcp.vcptoolbox.modelsPath.title": "模型路径",
  "settings.vcp.vcptoolbox.modelsPath.description": "模型端点路径片段。",
  "settings.vcp.vcptoolbox.modelsURL.title": "模型完整 URL",
  "settings.vcp.vcptoolbox.modelsURL.description": "模型端点绝对 URL（覆盖基础 URL + 路径）。",
  "settings.vcp.vcptoolbox.apiKey.title": "API 密钥",
  "settings.vcp.vcptoolbox.apiKey.description": "vcptoolbox 提供商 API 密钥覆盖值。",
  "common.remove": "移除",
  "common.top": "置顶",
  "common.up": "上移",
  "common.down": "下移",
  "prompt.busy.sendNow": "立即发送",
  "prompt.busy.queue": "加入队列",
  "prompt.busy.interruptSend": "中断并发送",
  "profile.personalAccount": "个人账户",
  "command.tab.close": "关闭标签页",
  "command.workspace.toggle.description": "切换工作区树显示",
  "common.goForward": "前进",
  "language.ar": "阿拉伯语",
  "language.br": "葡萄牙语（巴西）",
  "language.bs": "波斯尼亚语",
  ...
  "language.zh": "简体中文",
  "language.zht": "繁体中文",
  "session.header.open.action": "打开",
  "session.header.open.ariaLabel": "打开菜单",
  "session.header.open.copyPath": "复制路径",
  "session.header.open.menu": "打开选项",
  "session.header.openIn": "打开于",
  ...
  "settings.context.memory.afterToolCall.description": "工具执行后刷新记忆。",
  "settings.context.memory.afterToolCall.title": "工具后刷新",
  "settings.context.memory.atomicTotal": "原子记忆总数",
  "settings.context.memory.clearOverrides": "清除覆盖设置",
  "settings.context.memory.compressPreview": "压缩预览",
  "settings.context.memory.defaultTopK.description": "默认记忆检索 Top-K。",
  "settings.context.memory.defaultTopK.title": "默认 Top-K",
  "settings.context.memory.exclude": "排除",
  "settings.context.memory.folderWeight.description": "文件夹记忆刷新权重（0~1）。",
  "settings.context.memory.folderWeight.title": "文件夹权重",
  "settings.context.memory.forceFirstMessage.description": "会话第一条用户消息始终写入记忆。",
  "settings.context.memory.forceFirstMessage.title": "首条消息强制写入",
  "settings.context.memory.include": "包含",
  "settings.context.memory.includeFolderDoc.description": "在上下文注入中包含文件夹级记忆摘要。",
  "settings.context.memory.includeFolderDoc.title": "包含文件夹文档",
  "settings.context.memory.includeProfile.description": "在上下文注入中包含用户画像记忆。",
  "settings.context.memory.includeProfile.title": "包含用户画像",
  "settings.context.memory.includeSessionSnippets.description": "在上下文注入中包含当前会话相关片段。",
  "settings.context.memory.includeSessionSnippets.title": "包含会话片段",
  "settings.context.memory.maxAtomic.description": "保留的原子记忆最大数量。",
  "settings.context.memory.maxAtomic.title": "原子记忆上限",
  "settings.context.memory.maxChars.description": "注入记忆上下文的最大字符数。",
  "settings.context.memory.maxChars.title": "最大字符数",
  "settings.context.memory.maxPerMessage.description": "每条用户消息最多写入记忆次数。",
  "settings.context.memory.maxPerMessage.title": "每条消息上限",
  "settings.context.memory.minChars.description": "触发写入器的最小消息长度。",
  "settings.context.memory.minChars.title": "最小字符数",
  "settings.context.memory.passiveEnabled.description": "将记忆片段注入到系统上下文。",
  "settings.context.memory.passiveEnabled.title": "被动注入启用",
  "settings.context.memory.pin": "置顶",
  "settings.context.memory.preview.button": "预览",
  "settings.context.memory.preview.placeholder": "输入查询以预览上下文框...",
  "settings.context.memory.preview.resultPlaceholder": "上下文预览将显示在这里...",
  "settings.context.memory.profileWeight.description": "用户画像记忆刷新权重（0~1）。",
  "settings.context.memory.profileWeight.title": "画像权重",
  "settings.context.memory.refreshEnabled.description": "启用工具后记忆刷新策略。",
  "settings.context.memory.refreshEnabled.title": "启用刷新",
  "settings.context.memory.retrievalEnabled.description": "启用记忆检索参数覆盖。",
  "settings.context.memory.retrievalEnabled.title": "启用检索覆盖",
  "settings.context.memory.runtimeEnabled.description": "VCP 记忆运行时总开关。",
  "settings.context.memory.runtimeEnabled.title": "记忆运行时启用",
  "settings.context.memory.search.placeholder": "搜索记忆...",
  "settings.context.memory.semanticWeight.description": "语义路由权重（0~1）。",
  "settings.context.memory.semanticWeight.title": "语义权重",
  "settings.context.memory.timeWeight.description": "时间路由权重（0~1）。",
  "settings.context.memory.timeWeight.title": "时间权重",
  "settings.context.memory.topKAtomic.description": "用于被动注入的原子记忆 Top-K。",
  "settings.context.memory.topKAtomic.title": "原子记忆 Top-K",
  "settings.context.memory.topKSession.description": "用于被动注入的会话片段 Top-K。",
  "settings.context.memory.topKSession.title": "会话片段 Top-K",
  "settings.context.memory.unpin": "取消置顶",
  "settings.context.memory.updateFolderDoc.description": "允许写入器更新文件夹文档记忆。",
  "settings.context.memory.updateFolderDoc.title": "更新文件夹文档",
  "settings.context.memory.updateProfile.description": "允许写入器更新用户画像记忆。",
  "settings.context.memory.updateProfile.title": "更新用户画像",
  "settings.context.memory.writerEnabled.description": "每条用户消息后异步写入记忆。",
  "settings.context.memory.writerEnabled.title": "写入器启用",
  "settings.context.section.compaction": "1）上下文 / 压缩",
  "settings.context.section.injection": "2）记忆注入（被动 + 检索）",
  "settings.context.section.management": "4）记忆存储管理",
  "settings.context.section.preview": "5）上下文框预览",
  "settings.context.section.writer": "3）记忆写入（Writer + Refresh）",
  "settings.terminal.bashPermission.description": "终端工具请求执行命令时的默认权限策略。",
  "settings.terminal.bashPermission.title": "Bash 权限",
  "settings.terminal.diffStyle.description": "终端 diff 块在 TUI 中的渲染方式。",
  "settings.terminal.diffStyle.title": "Diff 样式",
  "settings.terminal.scrollSpeed.description": "TUI 模式下的终端基础滚动速度。",
  "settings.terminal.scrollSpeed.title": "滚动速度",
  "settings.terminal.suspendKeybind.description": "TUI 模式下用于暂停终端的快捷键。",
  "settings.terminal.suspendKeybind.title": "终端暂停快捷键",
  "settings.terminal.titleToggleKeybind.description": "TUI 模式下用于切换终端标题的快捷键。",
  "settings.terminal.titleToggleKeybind.title": "终端标题切换快捷键",
  "settings.vcp.group.basic": "VCP 核心协议",
  "settings.vcp.group.memory": "记忆",
  "settings.vcp.group.toolbox": "VCPToolBox",
  "settings.workflows.agent.description": "可选的智能体覆盖设置。",
  "settings.workflows.agent.title": "智能体",
  "settings.workflows.description.description": "命令面板中显示的可选简短描述。",
  "settings.workflows.description.placeholder": "审查暂存文件并列出风险。",
  "settings.workflows.description.title": "描述",
  "settings.workflows.empty": "尚未配置工作流。",
  "settings.workflows.model.description": "可选模型覆盖，格式为 provider/model。",
  "settings.workflows.model.placeholder": "例如：vcptoolbox/gpt-4.1",
  "settings.workflows.model.title": "模型",
  "settings.workflows.name.description": "斜杠命令 ID。空格将自动转换为连字符。",
  "settings.workflows.name.placeholder": "例如：code-review",
  "settings.workflows.name.title": "工作流名称",
  "settings.workflows.subtask.description": "允许该工作流作为子任务命令运行。",
  "settings.workflows.subtask.title": "启用子任务模式",
  "settings.workflows.template.description": "Markdown 提示词模板内容。",
  "settings.workflows.template.placeholder": "请助手审查最近改动...",
  "settings.workflows.template.title": "模板",
  "toast.vcp.updated": "VCP 配置已更新。",
