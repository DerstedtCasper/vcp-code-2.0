...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "VCP 提供的免费模型",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接帐户，并在 VCP 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的帐户并在 VCP 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的帐户并在 VCP 中使用 {{provider}} 模型。",
  ...
  "dialog.server.description": "切换此应用连接的 VCP 服务器。",
  ...
  "toast.update.description": "VCP 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 VCP 团队",
  ...
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意: VCP 暂不支持 MCP 认证。',
  ...
  "sidebar.gettingStarted.line1": "VCP 提供免费模型，你可以立即开始使用。",
  ...
  "settings.general.row.language.description": "更改 VCP 的显示语言",
  "settings.general.row.appearance.title": "外观",
  "settings.general.row.appearance.description": "自定义 VCP 在你的设备上的外观",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 VCP 的主题。",
  ...
  "settings.updates.row.startup.description": "在 VCP 启动时自动检查更新",
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 VCP。",
  ...
  "profile.action.login": "使用 VCP Code 登录",
  "profile.balance.title": "余额",
  "profile.balance.refresh": "刷新余额",
  "profile.action.dashboard": "控制面板",
  "profile.action.logout": "退出登录",
  "view.marketplace.title": "市场",
  "vcp.view.status.enabled": "已启用",
  "vcp.view.status.disabled": "已禁用",
  "vcp.view.title": "VCP 控制中心",
  "vcp.view.description": "集中展示 VCP 协议桥接、队列运行态与诊断信息。",
  "vcp.view.protocol.title": "协议桥接",
  "vcp.view.protocol.contextFold": "上下文折叠",
  "vcp.view.protocol.vcpInfo": "VCP 信息",
  "vcp.view.protocol.toolRequest": "工具请求桥接",
  "vcp.view.protocol.htmlRender": "HTML 渲染",
  "vcp.view.protocol.agentTeam": "Agent Team",
  "vcp.view.protocol.memoryRuntime": "记忆运行时",
  "vcp.view.runtime.title": "分布式运行态",
  "vcp.view.runtime.activeSession": "活动会话",
  "vcp.view.runtime.sessionStatus": "会话状态",
  "vcp.view.runtime.queuedPrompts": "排队提示数",
  "vcp.view.runtime.pendingPermissions": "待处理权限",
  "vcp.view.runtime.pendingQuestions": "待处理问题",
  "vcp.view.diagnostics.title": "诊断",
  "vcp.view.diagnostics.connection": "连接",
  "vcp.view.diagnostics.serverPort": "服务端口",
  "vcp.view.diagnostics.extensionVersion": "扩展版本",
  "vcp.view.diagnostics.error": "错误",
  "vcp.view.visualization.title": "VCP 运行态可视化",
  "vcp.view.visualization.foldBlocks": "动态折叠块",
  "vcp.view.visualization.vcpInfoBlocks": "VCPInfo 块",
  "vcp.view.visualization.toolRequestBlocks": "工具请求块",
  "vcp.view.observability.title": "WindowSensor / ScreenPilot 观测",
  "vcp.view.observability.windowSensorCalls": "WindowSensor 调用次数",
  "vcp.view.observability.screenPilotCalls": "ScreenPilot 调用次数",
  "vcp.view.observability.browserAutomation": "浏览器自动化",
  ...
  "settings.aboutKiloCode.title": "关于 VCP Code",

  "session.messages.empty": "在下方输入消息以开始对话。",
  "session.messages.welcome": "VCP Code 是一个 AI 编程助手。让它帮你构建功能、修复 bug 或解释代码库。",
  ...
  "settings.aboutKiloCode.extensionName": "VCP Code 扩展",
  "settings.aboutKiloCode.community": "社区与支持",
  "settings.aboutKiloCode.feedback.prefix": "如果您有任何问题或反馈，欢迎访问",
  "settings.aboutKiloCode.feedback.or": "或",
  "settings.aboutKiloCode.support.prefix": "如有支持或账户问题，请在以下地址提交 issue",
  "settings.aboutKiloCode.resetSettings.title": "重置设置",
  "settings.aboutKiloCode.resetSettings.description":
    "将所有 VCP Code 扩展设置重置为默认值。这不会影响 CLI 或后端配置。",
  "settings.aboutKiloCode.resetSettings.button": "重置所有设置",

  "settings.agentBehaviour.subtab.modes": "模式",
  "settings.agentBehaviour.subtab.agents": "智能体",
  ...
  "settings.language.description": '"自动"将使用 VS Code 的显示语言。选择 VCP Code 界面的语言。',
  ...
  "settings.agentBehaviour.loadedSkills": "已加载技能",
  "settings.agentBehaviour.skillsLoading": "正在从 CLI 后端加载技能…",
  "settings.agentBehaviour.skillsEmpty": "未发现技能。请添加技能路径/URL 或安装内置技能。",
  ...
  "settings.agentBehaviour.instructionFiles.placeholder": "例如：./INSTRUCTIONS.md",
  "settings.agentBehaviour.modelOverride.placeholder": "例如：anthropic/claude-sonnet-4-20250514",
  "settings.agentBehaviour.prompt.placeholder": "自定义指令…",
  "settings.agentBehaviour.skillPaths.placeholder": "例如：./skills",
  "settings.agentBehaviour.skillUrls.placeholder": "例如：https://example.com/skills",
  "settings.agentBehaviour.mcp.command": "命令",
  "settings.agentBehaviour.mcp.url": "URL",

  "settings.agentBehaviour.vcp.compat.title": "启用 VCP 兼容",
  "settings.agentBehaviour.vcp.compat.description": "VCP 解析与渲染的总开关。",
  "settings.agentBehaviour.vcp.compat.label": "启用 VCP 兼容",

  "settings.agentBehaviour.vcp.contextFold.enabled.title": "启用动态折叠（VCP_DYNAMIC_FOLD）",
  "settings.agentBehaviour.vcp.contextFold.enabled.description": "解析并渲染 VCP_DYNAMIC_FOLD 块。",
  "settings.agentBehaviour.vcp.contextFold.enabled.label": "启用动态折叠",
  "settings.agentBehaviour.vcp.contextFold.output.title": "动态折叠输出样式",
  "settings.agentBehaviour.vcp.contextFold.output.description": "将折叠块渲染为 details 或普通 Markdown。",
  "settings.agentBehaviour.vcp.contextFold.output.details": "详情",
  "settings.agentBehaviour.vcp.contextFold.output.plain": "纯文本",
  "settings.agentBehaviour.vcp.contextFold.startMarker.title": "动态折叠开始标记",
  "settings.agentBehaviour.vcp.contextFold.startMarker.description": "用于识别折叠块开始的标记。",
  "settings.agentBehaviour.vcp.contextFold.endMarker.title": "动态折叠结束标记",
  "settings.agentBehaviour.vcp.contextFold.endMarker.description": "用于识别折叠块结束的标记。",

  "settings.agentBehaviour.vcp.vcpInfo.enabled.title": "启用 VCPInfo",
  "settings.agentBehaviour.vcp.vcpInfo.enabled.description": "提取 VCPINFO 块并发送通知。",
  "settings.agentBehaviour.vcp.vcpInfo.enabled.label": "启用 VCPInfo",
  "settings.agentBehaviour.vcp.vcpInfo.startMarker.title": "VCPInfo 开始标记",
  "settings.agentBehaviour.vcp.vcpInfo.startMarker.description": "用于识别 VCPInfo 块开始的标记。",
  "settings.agentBehaviour.vcp.vcpInfo.endMarker.title": "VCPInfo 结束标记",
  "settings.agentBehaviour.vcp.vcpInfo.endMarker.description": "用于识别 VCPInfo 块结束的标记。",

  "settings.agentBehaviour.vcp.toolRequest.enabled.title": "启用 TOOL_REQUEST",
  "settings.agentBehaviour.vcp.toolRequest.enabled.description": "解析 TOOL_REQUEST 协议块并桥接事件。",
  "settings.agentBehaviour.vcp.toolRequest.enabled.label": "启用 TOOL_REQUEST",
  "settings.agentBehaviour.vcp.toolRequest.bridgeMode.title": "TOOL_REQUEST 桥接模式",
  "settings.agentBehaviour.vcp.toolRequest.bridgeMode.description": "`execute` 自动执行匹配工具；`event` 仅发送协议事件。",
  "settings.agentBehaviour.vcp.toolRequest.bridgeMode.execute": "执行",
  "settings.agentBehaviour.vcp.toolRequest.bridgeMode.event": "仅事件",
  "settings.agentBehaviour.vcp.toolRequest.maxPerMessage.title": "每条消息最大 TOOL_REQUEST 数",
  "settings.agentBehaviour.vcp.toolRequest.maxPerMessage.description": "自动执行 TOOL_REQUEST 的安全上限。",
  "settings.agentBehaviour.vcp.toolRequest.maxPerMessage.placeholder": "例如：3",
  "settings.agentBehaviour.vcp.toolRequest.allowTools.title": "TOOL_REQUEST 允许工具",
  "settings.agentBehaviour.vcp.toolRequest.allowTools.description":
    "逗号分隔的白名单；留空表示全允许（除非被拒绝名单覆盖）。",
  "settings.agentBehaviour.vcp.toolRequest.allowTools.placeholder": "例如：search_memory, read, glob",
  "settings.agentBehaviour.vcp.toolRequest.denyTools.title": "TOOL_REQUEST 拒绝工具",
  "settings.agentBehaviour.vcp.toolRequest.denyTools.description": "逗号分隔的拒绝名单；优先级高于允许名单。",
  "settings.agentBehaviour.vcp.toolRequest.denyTools.placeholder": "例如：bash",
  "settings.agentBehaviour.vcp.toolRequest.keepInOutput.title": "在输出中保留 TOOL_REQUEST 块",
  "settings.agentBehaviour.vcp.toolRequest.keepInOutput.description": "在助手输出中保留可见的 TOOL_REQUEST 块。",
  "settings.agentBehaviour.vcp.toolRequest.keepInOutput.label": "保留 TOOL_REQUEST 块",
  "settings.agentBehaviour.vcp.toolRequest.startMarker.title": "TOOL_REQUEST 开始标记",
  "settings.agentBehaviour.vcp.toolRequest.startMarker.description": "用于识别 TOOL_REQUEST 块开始的标记。",
  "settings.agentBehaviour.vcp.toolRequest.endMarker.title": "TOOL_REQUEST 结束标记",
  "settings.agentBehaviour.vcp.toolRequest.endMarker.description": "用于识别 TOOL_REQUEST 块结束的标记。",

  "settings.agentBehaviour.vcp.html.enabled.title": "允许 HTML 渲染",
  "settings.agentBehaviour.vcp.html.enabled.description": "关闭后会转义助手输出中的原始 HTML。",
  "settings.agentBehaviour.vcp.html.enabled.label": "允许 HTML 渲染",

  "settings.agentBehaviour.vcp.agentTeam.enabled.title": "启用智能体团队",
  "settings.agentBehaviour.vcp.agentTeam.enabled.description": "启用编排器分波策略与团队元数据指引。",
  "settings.agentBehaviour.vcp.agentTeam.enabled.label": "启用智能体团队",
  "settings.agentBehaviour.vcp.agentTeam.maxParallel.title": "每波最大并行子任务数",
  "settings.agentBehaviour.vcp.agentTeam.maxParallel.description": "每个 wave 允许的最大子任务数。",
  "settings.agentBehaviour.vcp.agentTeam.maxParallel.placeholder": "例如：3",
  "settings.agentBehaviour.vcp.agentTeam.waveStrategy.title": "分波策略",
  "settings.agentBehaviour.vcp.agentTeam.waveStrategy.description": "编排器任务的 wave 调度策略。",
  "settings.agentBehaviour.vcp.agentTeam.waveStrategy.auto": "自动",
  "settings.agentBehaviour.vcp.agentTeam.waveStrategy.conservative": "保守",
  "settings.agentBehaviour.vcp.agentTeam.waveStrategy.aggressive": "激进",
  "settings.agentBehaviour.vcp.agentTeam.requireFileSeparation.title": "要求文件不重叠",
  "settings.agentBehaviour.vcp.agentTeam.requireFileSeparation.description": "仅在子任务涉及文件互不重叠时才并行化。",
  "settings.agentBehaviour.vcp.agentTeam.requireFileSeparation.label": "要求文件不重叠",
  "settings.agentBehaviour.vcp.agentTeam.handoffFormat.title": "交接格式",
  "settings.agentBehaviour.vcp.agentTeam.handoffFormat.description": "委派任务总结的首选格式。",
  "settings.agentBehaviour.vcp.agentTeam.handoffFormat.summary": "摘要",
  "settings.agentBehaviour.vcp.agentTeam.handoffFormat.checklist": "清单",

  "settings.agentBehaviour.vcp.memory.title": "记忆设置",
  "settings.agentBehaviour.vcp.vcptoolbox.title": "vcptoolbox 提供商",
  "settings.agentBehaviour.vcp.vcptoolbox.baseUrl.title": "基础 URL",
  "settings.agentBehaviour.vcp.vcptoolbox.baseUrl.description": "提供商 API 基础地址。",
  "settings.agentBehaviour.vcp.vcptoolbox.modelsPath.title": "模型路径",
  "settings.agentBehaviour.vcp.vcptoolbox.modelsPath.description": "models 接口的路径片段。",
  "settings.agentBehaviour.vcp.vcptoolbox.modelsUrl.title": "模型 URL",
  "settings.agentBehaviour.vcp.vcptoolbox.modelsUrl.description": "models 接口的绝对 URL 覆盖。",
  "settings.agentBehaviour.vcp.vcptoolbox.apiKey.title": "API 密钥",
  "settings.agentBehaviour.vcp.vcptoolbox.apiKey.description": "vcptoolbox 提供商的 API key 覆盖。",

  "settings.workflows.empty": "尚未配置任何工作流。",
  "settings.workflows.name.title": "工作流名称",
  "settings.workflows.name.description": "斜杠命令 ID（空格会自动转换为连字符 -）。",
  "settings.workflows.name.placeholder": "例如：code-review",
  "settings.workflows.template.title": "模板",
  "settings.workflows.template.description": "Markdown 提示词模板内容。",
  "settings.workflows.template.placeholder": "例如：让助手审查最近的改动……",
  "settings.workflows.description.title": "描述",
  "settings.workflows.description.description": "可选：用于命令面板的简短说明。",
  "settings.workflows.description.placeholder": "例如：审查暂存文件并列出风险。",
  "settings.workflows.agent.title": "智能体",
  "settings.workflows.agent.description": "可选：覆盖默认智能体。",
  "settings.workflows.model.title": "模型",
  "settings.workflows.model.description": "可选：覆盖默认模型（provider/model 格式）。",
  "settings.workflows.model.placeholder": "例如：vcptoolbox/gpt-4.1",
  "settings.workflows.subtask.title": "启用子任务模式",
  "settings.workflows.subtask.description": "允许此工作流作为子任务命令运行。",
  "settings.workflows.subtask.label": "启用子任务模式",
  ...
  "settings.context.watcherPatterns.placeholder": "例如：**/node_modules/**",
  "settings.context.section.compaction": "基础压缩",
  "settings.context.section.memoryInjection": "记忆注入（被动 + 检索）",
  "settings.context.section.memoryWriter": "记忆写入（写入器 + 刷新）",
  "settings.context.section.memoryAdmin": "记忆库管理（概览 / 搜索 / 更新 / 删除）",
  "settings.context.section.preview": "上下文盒规则（预览）",

  "settings.context.memory.runtime.title": "启用记忆运行态",
  "settings.context.memory.runtime.description": "VCP 记忆运行态主开关。",

  "settings.context.memory.passive.enabled.title": "启用被动注入",
  "settings.context.memory.passive.enabled.description": "将记忆片段注入到系统上下文中。",
  "settings.context.memory.passive.includeProfile.title": "包含用户画像",
  "settings.context.memory.passive.includeProfile.description": "在注入时包含用户画像记忆。",
  "settings.context.memory.passive.includeFolderDoc.title": "包含文件夹文档",
  "settings.context.memory.passive.includeFolderDoc.description": "在注入时包含文件夹级别的记忆摘要。",
  "settings.context.memory.passive.includeSessionSnippets.title": "包含会话片段",
  "settings.context.memory.passive.includeSessionSnippets.description": "包含当前会话消息中的相关片段。",
  "settings.context.memory.passive.topKAtomic.title": "Top K（原子）",
  "settings.context.memory.passive.topKAtomic.description": "被动注入时选取的原子记忆 Top-K。",
  "settings.context.memory.passive.topKSession.title": "Top K（会话）",
  "settings.context.memory.passive.topKSession.description": "被动注入时选取的会话片段 Top-K。",
  "settings.context.memory.passive.maxChars.title": "最大字符数",
  "settings.context.memory.passive.maxChars.description": "注入的记忆上下文最大字符数。",

  "settings.context.memory.retrieval.enabled.title": "启用检索覆盖",
  "settings.context.memory.retrieval.enabled.description": "允许对记忆检索查询参数进行覆盖。",
  "settings.context.memory.retrieval.semanticWeight.title": "语义权重",
  "settings.context.memory.retrieval.semanticWeight.description": "语义路由权重（0~1）。",
  "settings.context.memory.retrieval.timeWeight.title": "时间权重",
  "settings.context.memory.retrieval.timeWeight.description": "时间路由权重（0~1）。",
  "settings.context.memory.retrieval.defaultTopK.title": "默认 Top K",
  "settings.context.memory.retrieval.defaultTopK.description": "默认记忆搜索 Top-K。",

  "settings.context.memory.writer.enabled.title": "启用写入器",
  "settings.context.memory.writer.enabled.description": "每条用户消息后异步写入记忆。",
  "settings.context.memory.writer.minChars.title": "最小字符数",
  "settings.context.memory.writer.minChars.description": "触发写入的最小消息长度。",
  "settings.context.memory.writer.maxAtomic.title": "最大原子数量",
  "settings.context.memory.writer.maxAtomic.description": "保留的原子记忆最大数量。",
  "settings.context.memory.writer.maxPerMessage.title": "每条消息最大写入数",
  "settings.context.memory.writer.maxPerMessage.description": "每条用户消息允许写入的最大记忆条数。",
  "settings.context.memory.writer.forceFirstMessage.title": "强制首条写入",
  "settings.context.memory.writer.forceFirstMessage.description": "在会话的第一条用户消息上总是写入记忆。",
  "settings.context.memory.writer.updateProfile.title": "更新用户画像",
  "settings.context.memory.writer.updateProfile.description": "允许写入器更新用户画像记忆。",
  "settings.context.memory.writer.updateFolderDoc.title": "更新文件夹文档",
  "settings.context.memory.writer.updateFolderDoc.description": "允许写入器更新文件夹文档记忆。",

  "settings.context.memory.refresh.enabled.title": "启用刷新",
  "settings.context.memory.refresh.enabled.description": "启用工具调用后的记忆刷新策略。",
  "settings.context.memory.refresh.afterToolCall.title": "工具调用后刷新",
  "settings.context.memory.refresh.afterToolCall.description": "在工具执行后刷新记忆。",
  "settings.context.memory.refresh.profileWeight.title": "画像权重",
  "settings.context.memory.refresh.profileWeight.description": "画像记忆刷新权重（0~1）。",
  "settings.context.memory.refresh.folderWeight.title": "文件夹权重",
  "settings.context.memory.refresh.folderWeight.description": "文件夹记忆刷新权重（0~1）。",

  "settings.context.memory.admin.atomicTotal": "原子记忆总数：{{count}}",
  "settings.context.memory.admin.profile.preferences": "画像·偏好",
  "settings.context.memory.admin.profile.style": "画像·风格",
  "settings.context.memory.admin.profile.facts": "画像·事实",
  "settings.context.memory.admin.search.placeholder": "搜索记忆…",
  "settings.context.memory.admin.search.action": "搜索",
  "settings.context.memory.admin.pin.on": "置顶",
  "settings.context.memory.admin.pin.off": "取消置顶",
  "settings.context.memory.admin.exclude.on": "排除",
  "settings.context.memory.admin.exclude.off": "包含",
  "settings.context.memory.admin.score": "得分",
  "settings.context.memory.admin.id": "ID",

  "settings.context.preview.compress": "压缩预览",
  "settings.context.preview.stats": "置顶：{{pinned}} | 排除：{{excluded}}",
  "settings.context.preview.clear": "清除覆盖",
  "settings.context.preview.query.placeholder": "输入查询以预览上下文盒…",
  "settings.context.preview.action": "预览",
  "settings.context.preview.result.placeholder": "上下文预览将显示在这里…",

  "settings.terminal.bashPermission.title": "Bash 权限",
  "settings.terminal.bashPermission.description": "当终端工具请求执行命令时的默认权限策略。",
  "settings.terminal.keybindSuspend.title": "终端挂起快捷键",
  "settings.terminal.keybindSuspend.description": "在 TUI 模式下挂起终端的快捷键。",
  "settings.terminal.keybindSuspend.placeholder": "例如：ctrl+z",
  "settings.terminal.keybindTitleToggle.title": "终端标题切换快捷键",
  "settings.terminal.keybindTitleToggle.description": "在 TUI 模式下切换终端标题显示的快捷键。",
  "settings.terminal.keybindTitleToggle.placeholder": "留空禁用",
  "settings.terminal.diffStyle.title": "Diff 样式",
  "settings.terminal.diffStyle.description": "在 TUI 中如何渲染终端 diff 块。",
  "settings.terminal.diffStyle.auto": "自动",
  "settings.terminal.diffStyle.stacked": "堆叠",
  "settings.terminal.scrollSpeed.title": "滚动速度",
  "settings.terminal.scrollSpeed.description": "TUI 模式下终端的基础滚动速度。",
  "settings.display.username.title": "用户名",
  "settings.display.username.description": "对话中显示的自定义用户名",
  "settings.display.username.placeholder": "用户",
  ...
  "settings.providers.profile.placeholder": "选择配置文件…",
  "settings.providers.headers.key.placeholder": "Header 键",
  "settings.providers.headers.value.placeholder": "Header 值",
  "settings.providers.providerSelect.placeholder": "选择提供者…",
