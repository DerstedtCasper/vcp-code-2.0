export const dict = {
  ...
  "settings.aboutKiloCode.title": "About VCP Code",
  ...
  "settings.agentBehaviour.vcp.compat.title": "Enable VCP Compatibility",
  "settings.agentBehaviour.vcp.compat.description": "Master switch for VCP parsing and rendering.",
  "settings.agentBehaviour.vcp.compat.label": "Enable VCP Compatibility",

  "settings.agentBehaviour.vcp.contextFold.enabled.title": "Context Fold Enabled",
  "settings.agentBehaviour.vcp.contextFold.enabled.description": "Parse and render VCP_DYNAMIC_FOLD blocks.",
  "settings.agentBehaviour.vcp.contextFold.enabled.label": "Context Fold Enabled",
  "settings.agentBehaviour.vcp.contextFold.output.title": "Context Fold Output",
  "settings.agentBehaviour.vcp.contextFold.output.description": "Render context folds as details or plain markdown.",
  "settings.agentBehaviour.vcp.contextFold.output.details": "Details",
  "settings.agentBehaviour.vcp.contextFold.output.plain": "Plain",
  "settings.agentBehaviour.vcp.contextFold.startMarker.title": "Context Fold Start Marker",
  "settings.agentBehaviour.vcp.contextFold.startMarker.description": "Marker used to detect fold block start.",
  "settings.agentBehaviour.vcp.contextFold.endMarker.title": "Context Fold End Marker",
  "settings.agentBehaviour.vcp.contextFold.endMarker.description": "Marker used to detect fold block end.",

  "settings.agentBehaviour.vcp.vcpInfo.enabled.title": "VCPInfo Enabled",
  "settings.agentBehaviour.vcp.vcpInfo.enabled.description": "Extract VCPINFO blocks and emit notifications.",
  "settings.agentBehaviour.vcp.vcpInfo.enabled.label": "VCPInfo Enabled",
  "settings.agentBehaviour.vcp.vcpInfo.startMarker.title": "VCPInfo Start Marker",
  "settings.agentBehaviour.vcp.vcpInfo.startMarker.description": "Marker used to detect VCPInfo block start.",
  "settings.agentBehaviour.vcp.vcpInfo.endMarker.title": "VCPInfo End Marker",
  "settings.agentBehaviour.vcp.vcpInfo.endMarker.description": "Marker used to detect VCPInfo block end.",

  "settings.agentBehaviour.vcp.toolRequest.enabled.title": "TOOL_REQUEST Enabled",
  "settings.agentBehaviour.vcp.toolRequest.enabled.description": "Parse TOOL_REQUEST protocol blocks and bridge events.",
  "settings.agentBehaviour.vcp.toolRequest.enabled.label": "TOOL_REQUEST Enabled",
  "settings.agentBehaviour.vcp.toolRequest.bridgeMode.title": "TOOL_REQUEST Bridge Mode",
  "settings.agentBehaviour.vcp.toolRequest.bridgeMode.description":
    "execute runs matched tools, event only emits protocol events.",
  "settings.agentBehaviour.vcp.toolRequest.bridgeMode.execute": "Execute",
  "settings.agentBehaviour.vcp.toolRequest.bridgeMode.event": "Event only",
  "settings.agentBehaviour.vcp.toolRequest.maxPerMessage.title": "TOOL_REQUEST Max Per Message",
  "settings.agentBehaviour.vcp.toolRequest.maxPerMessage.description": "Safety cap for auto-executed TOOL_REQUEST blocks.",
  "settings.agentBehaviour.vcp.toolRequest.maxPerMessage.placeholder": "e.g. 3",
  "settings.agentBehaviour.vcp.toolRequest.allowTools.title": "TOOL_REQUEST Allow Tools",
  "settings.agentBehaviour.vcp.toolRequest.allowTools.description":
    "Comma-separated allowlist. Empty means all tools are allowed unless denied.",
  "settings.agentBehaviour.vcp.toolRequest.allowTools.placeholder": "e.g. search_memory, read, glob",
  "settings.agentBehaviour.vcp.toolRequest.denyTools.title": "TOOL_REQUEST Deny Tools",
  "settings.agentBehaviour.vcp.toolRequest.denyTools.description":
    "Comma-separated denylist. Takes precedence over allowlist.",
  "settings.agentBehaviour.vcp.toolRequest.denyTools.placeholder": "e.g. bash",
  "settings.agentBehaviour.vcp.toolRequest.keepInOutput.title": "TOOL_REQUEST Keep In Output",
  "settings.agentBehaviour.vcp.toolRequest.keepInOutput.description":
    "Keep TOOL_REQUEST blocks visible in assistant output.",
  "settings.agentBehaviour.vcp.toolRequest.keepInOutput.label": "TOOL_REQUEST Keep In Output",
  "settings.agentBehaviour.vcp.toolRequest.startMarker.title": "TOOL_REQUEST Start Marker",
  "settings.agentBehaviour.vcp.toolRequest.startMarker.description": "Marker used to detect TOOL_REQUEST block start.",
  "settings.agentBehaviour.vcp.toolRequest.endMarker.title": "TOOL_REQUEST End Marker",
  "settings.agentBehaviour.vcp.toolRequest.endMarker.description": "Marker used to detect TOOL_REQUEST block end.",

  "settings.agentBehaviour.vcp.html.enabled.title": "Allow HTML Rendering",
  "settings.agentBehaviour.vcp.html.enabled.description": "Disable to escape raw HTML in assistant output.",
  "settings.agentBehaviour.vcp.html.enabled.label": "Allow HTML Rendering",

  "settings.agentBehaviour.vcp.agentTeam.enabled.title": "Agent Team Enabled",
  "settings.agentBehaviour.vcp.agentTeam.enabled.description":
    "Enable orchestrator wave strategy and team metadata guidance.",
  "settings.agentBehaviour.vcp.agentTeam.enabled.label": "Agent Team Enabled",
  "settings.agentBehaviour.vcp.agentTeam.maxParallel.title": "Agent Team Max Parallel",
  "settings.agentBehaviour.vcp.agentTeam.maxParallel.description": "Maximum subtasks allowed per wave.",
  "settings.agentBehaviour.vcp.agentTeam.maxParallel.placeholder": "e.g. 3",
  "settings.agentBehaviour.vcp.agentTeam.waveStrategy.title": "Agent Team Wave Strategy",
  "settings.agentBehaviour.vcp.agentTeam.waveStrategy.description":
    "Wave scheduling strategy for orchestrator tasks.",
  "settings.agentBehaviour.vcp.agentTeam.waveStrategy.auto": "Auto",
  "settings.agentBehaviour.vcp.agentTeam.waveStrategy.conservative": "Conservative",
  "settings.agentBehaviour.vcp.agentTeam.waveStrategy.aggressive": "Aggressive",
  "settings.agentBehaviour.vcp.agentTeam.requireFileSeparation.title": "Agent Team Require File Separation",
  "settings.agentBehaviour.vcp.agentTeam.requireFileSeparation.description":
    "Only parallelize subtasks when touched files do not overlap.",
  "settings.agentBehaviour.vcp.agentTeam.requireFileSeparation.label": "Agent Team Require File Separation",
  "settings.agentBehaviour.vcp.agentTeam.handoffFormat.title": "Agent Team Handoff Format",
  "settings.agentBehaviour.vcp.agentTeam.handoffFormat.description":
    "Preferred handoff format for delegated task summaries.",
  "settings.agentBehaviour.vcp.agentTeam.handoffFormat.summary": "Summary",
  "settings.agentBehaviour.vcp.agentTeam.handoffFormat.checklist": "Checklist",

  "settings.agentBehaviour.vcp.memory.title": "Memory Settings",
  "settings.agentBehaviour.vcp.vcptoolbox.title": "vcptoolbox Provider",
  "settings.agentBehaviour.vcp.vcptoolbox.baseUrl.title": "Base URL",
  "settings.agentBehaviour.vcp.vcptoolbox.baseUrl.description": "Provider API base URL.",
  "settings.agentBehaviour.vcp.vcptoolbox.modelsPath.title": "Models Path",
  "settings.agentBehaviour.vcp.vcptoolbox.modelsPath.description": "Path segment for models endpoint.",
  "settings.agentBehaviour.vcp.vcptoolbox.modelsUrl.title": "Models URL",
  "settings.agentBehaviour.vcp.vcptoolbox.modelsUrl.description": "Absolute URL override for models endpoint.",
  "settings.agentBehaviour.vcp.vcptoolbox.apiKey.title": "API Key",
  "settings.agentBehaviour.vcp.vcptoolbox.apiKey.description": "API key override for vcptoolbox provider.",
  ...
  "settings.workflows.subtask.label": "Enable Subtask Mode",
  ...
  "settings.context.section.compaction": "Compaction basics",
  "settings.context.section.memoryInjection": "Memory injection (Passive + Retrieval)",
  "settings.context.section.memoryWriter": "Memory writing (Writer + Refresh)",
  "settings.context.section.memoryAdmin": "Memory management (Overview / Search / Update / Delete)",
  "settings.context.section.preview": "Context box rules (Preview)",

  "settings.context.memory.runtime.title": "Memory Runtime Enabled",
  "settings.context.memory.runtime.description": "Master switch for VCP memory runtime.",

  "settings.context.memory.passive.enabled.title": "Passive Enabled",
  "settings.context.memory.passive.enabled.description": "Inject memory snippets into system context.",
  "settings.context.memory.passive.includeProfile.title": "Include Profile",
  "settings.context.memory.passive.includeProfile.description": "Include user profile memory in context injection.",
  "settings.context.memory.passive.includeFolderDoc.title": "Include Folder Doc",
  "settings.context.memory.passive.includeFolderDoc.description":
    "Include folder-level memory summary in context injection.",
  "settings.context.memory.passive.includeSessionSnippets.title": "Include Session Snippets",
  "settings.context.memory.passive.includeSessionSnippets.description":
    "Include relevant snippets from current session messages.",
  "settings.context.memory.passive.topKAtomic.title": "Top K Atomic",
  "settings.context.memory.passive.topKAtomic.description": "Top-K atomic memories for passive injection.",
  "settings.context.memory.passive.topKSession.title": "Top K Session",
  "settings.context.memory.passive.topKSession.description": "Top-K session snippets for passive injection.",
  "settings.context.memory.passive.maxChars.title": "Max Chars",
  "settings.context.memory.passive.maxChars.description": "Maximum injected memory context size.",

  "settings.context.memory.retrieval.enabled.title": "Retrieval Enabled",
  "settings.context.memory.retrieval.enabled.description": "Enable retrieval parameter overrides for memory queries.",
  "settings.context.memory.retrieval.semanticWeight.title": "Semantic Weight",
  "settings.context.memory.retrieval.semanticWeight.description": "Semantic route weight (0~1).",
  "settings.context.memory.retrieval.timeWeight.title": "Time Weight",
  "settings.context.memory.retrieval.timeWeight.description": "Time route weight (0~1).",
  "settings.context.memory.retrieval.defaultTopK.title": "Default Top K",
  "settings.context.memory.retrieval.defaultTopK.description": "Default memory search top-K.",

  "settings.context.memory.writer.enabled.title": "Writer Enabled",
  "settings.context.memory.writer.enabled.description": "Write memory asynchronously after each user message.",
  "settings.context.memory.writer.minChars.title": "Min Chars",
  "settings.context.memory.writer.minChars.description": "Minimum message length to trigger writer.",
  "settings.context.memory.writer.maxAtomic.title": "Max Atomic",
  "settings.context.memory.writer.maxAtomic.description": "Maximum retained atomic memories.",
  "settings.context.memory.writer.maxPerMessage.title": "Max Per Message",
  "settings.context.memory.writer.maxPerMessage.description": "Maximum memory writes per user message.",
  "settings.context.memory.writer.forceFirstMessage.title": "Force First Message",
  "settings.context.memory.writer.forceFirstMessage.description":
    "Always write memory on the first user message in a session.",
  "settings.context.memory.writer.updateProfile.title": "Update Profile",
  "settings.context.memory.writer.updateProfile.description": "Allow writer to update user profile memory.",
  "settings.context.memory.writer.updateFolderDoc.title": "Update Folder Doc",
  "settings.context.memory.writer.updateFolderDoc.description":
    "Allow writer to update folder document memory.",

  "settings.context.memory.refresh.enabled.title": "Refresh Enabled",
  "settings.context.memory.refresh.enabled.description": "Enable post-tool memory refresh strategy.",
  "settings.context.memory.refresh.afterToolCall.title": "After Tool Call",
  "settings.context.memory.refresh.afterToolCall.description": "Refresh memory after tool execution.",
  "settings.context.memory.refresh.profileWeight.title": "Profile Weight",
  "settings.context.memory.refresh.profileWeight.description": "Refresh weight for profile memory (0~1).",
  "settings.context.memory.refresh.folderWeight.title": "Folder Weight",
  "settings.context.memory.refresh.folderWeight.description": "Refresh weight for folder memory (0~1).",

  "settings.context.memory.admin.atomicTotal": "Atomic Total: {{count}}",
  "settings.context.memory.admin.profile.preferences": "Profile.preferences",
  "settings.context.memory.admin.profile.style": "Profile.style",
  "settings.context.memory.admin.profile.facts": "Profile.facts",
  "settings.context.memory.admin.search.placeholder": "Search memory...",
  "settings.context.memory.admin.search.action": "Search",
  "settings.context.memory.admin.pin.on": "Pin",
  "settings.context.memory.admin.pin.off": "Unpin",
  "settings.context.memory.admin.exclude.on": "Exclude",
  "settings.context.memory.admin.exclude.off": "Include",
  "settings.context.memory.admin.score": "score",
  "settings.context.memory.admin.id": "id",

  "settings.context.preview.compress": "Compress Preview",
  "settings.context.preview.stats": "pin: {{pinned}} | exclude: {{excluded}}",
  "settings.context.preview.clear": "Clear Overrides",
  "settings.context.preview.query.placeholder": "Input a query to preview context box...",
  "settings.context.preview.action": "Preview",
  "settings.context.preview.result.placeholder": "Context preview will appear here...",

  "settings.terminal.bashPermission.title": "Bash Permission",
  "settings.terminal.bashPermission.description":
    "Default permission policy when terminal tools request command execution.",
  "settings.terminal.keybindSuspend.title": "Terminal Suspend Keybind",
  "settings.terminal.keybindSuspend.description": "Keybind used to suspend terminal in TUI mode.",
  "settings.terminal.keybindSuspend.placeholder": "ctrl+z",
  "settings.terminal.keybindTitleToggle.title": "Terminal Title Toggle Keybind",
  "settings.terminal.keybindTitleToggle.description": "Keybind used to toggle terminal title in TUI mode.",
  "settings.terminal.keybindTitleToggle.placeholder": "leave empty to disable",
  ...
  "settings.terminal.diffStyle.auto": "Auto",
  "settings.terminal.diffStyle.stacked": "Stacked",
  ...
  "settings.providers.profile.placeholder": "Select profile...",
  "settings.providers.headers.key.placeholder": "Header key",
  "settings.providers.headers.value.placeholder": "Header value",
  "settings.providers.providerSelect.placeholder": "Select provider...",
