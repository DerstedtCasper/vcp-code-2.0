...
export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.disabled": "VCP Code Autocomplete (अक्षम)",
  "kilocode:autocomplete.statusBar.tooltip.noCredits":
    "**आपके खाते में कोई क्रेडिट नहीं है**\n\nआपके VCP Code खाते में कोई क्रेडिट नहीं है। ऑटोकम्प्लीट का उपयोग करने के लिए, कृपया अपने खाते में क्रेडिट जोड़ें।\n\n[सेटिंग्स खोलें](command:vcp-code.new.settingsButtonClicked)",
  ...
  "kilocode:autocomplete.input.title": "VCP Code: त्वरित कार्य",
  "kilocode:autocomplete.input.placeholder": "जैसे, 'इस फ़ंक्शन को अधिक कुशल बनाने के लिए रिफैक्टर करें'",
  "kilocode:autocomplete.commands.generateSuggestions": "VCP Code: सुझाए गए संपादन जेनरेट करें",
  ...
  "kilocode:autocomplete.codeAction.title": "VCP Code: सुझाए गए संपादन",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "VCP Code Autocomplete को GitHub Copilot के साथ संघर्ष के कारण ब्लॉक किया जा रहा है। इसे ठीक करने के लिए, आपको Copilot के इनलाइन सुझावों को अक्षम करना होगा।",
