...
export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.disabled": "VCP Code Autocomplete (zakázáno)",
  "kilocode:autocomplete.statusBar.tooltip.noCredits":
    "**Na tvém účtu nejsou žádné kredity**\n\nTvůj účet VCP Code nemá žádné kredity. Pro použití automatického doplňování prosím přidej kredity na svůj účet.\n\n[Otevřít Nastavení](command:vcp-code.new.settingsButtonClicked)",
  ...
  "kilocode:autocomplete.input.title": "VCP Code: Rychlý úkol",
  "kilocode:autocomplete.input.placeholder": "např. 'refaktoruj tuto funkci, aby byla efektivnější'",
  "kilocode:autocomplete.commands.generateSuggestions": "VCP Code: Generovat navrhované úpravy",
  ...
  "kilocode:autocomplete.codeAction.title": "VCP Code: Navrhované úpravy",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "VCP Code Autocomplete je blokováno konfliktem s GitHub Copilot. Pro vyřešení tohoto problému musíš zakázat inline návrhy Copilot.",
