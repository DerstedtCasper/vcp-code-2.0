...
export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.disabled": "VCP Code Autocomplete (desabilitado)",
  "kilocode:autocomplete.statusBar.tooltip.noCredits":
    "**Sem créditos na sua conta**\n\nSua conta VCP Code não tem créditos. Para usar o autocompletar, adicione créditos à sua conta.\n\n[Abrir Configurações](command:vcp-code.new.settingsButtonClicked)",
  ...
  "kilocode:autocomplete.input.title": "VCP Code: Tarefa Rápida",
  "kilocode:autocomplete.input.placeholder": "ex., 'refatore esta função para ser mais eficiente'",
  "kilocode:autocomplete.commands.generateSuggestions": "VCP Code: Gerar Edições Sugeridas",
  ...
  "kilocode:autocomplete.codeAction.title": "VCP Code: Edições Sugeridas",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "O VCP Code Autocomplete está sendo bloqueado por um conflito com o GitHub Copilot. Para corrigir isso, você deve desabilitar as sugestões inline do Copilot.",
