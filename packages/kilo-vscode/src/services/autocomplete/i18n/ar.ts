...
export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.disabled": "VCP Code Autocomplete (معطل)",
  "kilocode:autocomplete.statusBar.tooltip.noCredits":
    "**لا يوجد رصيد في حسابك**\n\nحساب VCP Code الخاص بك لا يحتوي على رصيد. لاستخدام الإكمال التلقائي، يرجى إضافة رصيد إلى حسابك.\n\n[فتح الإعدادات](command:vcp-code.new.settingsButtonClicked)",
  ...
  "kilocode:autocomplete.input.title": "VCP Code: مهمة سريعة",
  "kilocode:autocomplete.input.placeholder": "مثال، 'أعد هيكلة هذه الدالة لتكون أكثر كفاءة'",
  "kilocode:autocomplete.commands.generateSuggestions": "VCP Code: إنشاء التعديلات المقترحة",
  ...
  "kilocode:autocomplete.codeAction.title": "VCP Code: التعديلات المقترحة",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "يتم حظر VCP Code Autocomplete بسبب تعارض مع GitHub Copilot. لإصلاح هذا، يجب عليك تعطيل اقتراحات Copilot المضمنة.",
