...
export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.disabled": "VCP Code Autocomplete (désactivé)",
  "kilocode:autocomplete.statusBar.tooltip.noCredits":
    "**Pas de crédits sur ton compte**\n\nTon compte VCP Code n'a pas de crédits. Pour utiliser l'autocomplétion, ajoute des crédits à ton compte.\n\n[Ouvrir les Paramètres](command:vcp-code.new.settingsButtonClicked)",
  ...
  "kilocode:autocomplete.input.title": "VCP Code : Tâche Rapide",
  "kilocode:autocomplete.input.placeholder": "ex., 'refactorise cette fonction pour plus d'efficacité'",
  "kilocode:autocomplete.commands.generateSuggestions": "VCP Code : Générer des Modifications Suggérées",
  ...
  "kilocode:autocomplete.codeAction.title": "VCP Code : Modifications Suggérées",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "Le VCP Code Autocomplete est bloqué par un conflit avec GitHub Copilot. Pour résoudre cela, tu dois désactiver les suggestions en ligne de Copilot.",
