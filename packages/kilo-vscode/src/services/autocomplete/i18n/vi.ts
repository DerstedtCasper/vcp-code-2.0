...
export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.disabled": "VCP Code Autocomplete (đã tắt)",
  "kilocode:autocomplete.statusBar.tooltip.noCredits":
    "**Không có tín dụng trong tài khoản của bạn**\n\nTài khoản VCP Code của bạn không có tín dụng. Để sử dụng tự động hoàn thành, vui lòng thêm tín dụng vào tài khoản của bạn.\n\n[Mở Cài đặt](command:vcp-code.new.settingsButtonClicked)",
  ...
  "kilocode:autocomplete.input.title": "VCP Code: Tác Vụ Nhanh",
  "kilocode:autocomplete.input.placeholder": "ví dụ, 'tái cấu trúc hàm này để hiệu quả hơn'",
  "kilocode:autocomplete.commands.generateSuggestions": "VCP Code: Tạo Các Chỉnh Sửa Được Đề Xuất",
  ...
  "kilocode:autocomplete.codeAction.title": "VCP Code: Các Chỉnh Sửa Được Đề Xuất",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "VCP Code Autocomplete đang bị chặn do xung đột với GitHub Copilot. Để khắc phục điều này, bạn phải tắt các gợi ý inline của Copilot.",
