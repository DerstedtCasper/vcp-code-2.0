...
export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.disabled": "VCP Code Autocomplete (disabled)",
  "kilocode:autocomplete.statusBar.tooltip.noCredits":
    "**No credits in your account**\n\nYour VCP Code account has no credits. To use autocomplete, please add credits to your account.\n\n[Open Settings](command:vcp-code.new.settingsButtonClicked)",
  ...
  "kilocode:autocomplete.input.title": "VCP Code: Quick Task",
  "kilocode:autocomplete.input.placeholder": "e.g., 'refactor this function to be more efficient'",
  "kilocode:autocomplete.commands.generateSuggestions": "VCP Code: Generate Suggested Edits",
  ...
  "kilocode:autocomplete.codeAction.title": "VCP Code: Suggested Edits",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "The VCP Code Autocomplete is being blocked by a conflict with GitHub Copilot. To fix this, you must disable Copilot's inline suggestions.",
