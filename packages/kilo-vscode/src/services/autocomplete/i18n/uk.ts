...
export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.disabled": "VCP Code Autocomplete (вимкнено)",
  "kilocode:autocomplete.statusBar.tooltip.noCredits":
    "**На вашому рахунку немає кредитів**\n\nНа вашому рахунку VCP Code немає кредитів. Щоб використовувати автодоповнення, будь ласка, поповніть рахунок.\n\n[Відкрити Налаштування](command:vcp-code.new.settingsButtonClicked)",
  ...
  "kilocode:autocomplete.input.title": "VCP Code: Швидке Завдання",
  "kilocode:autocomplete.input.placeholder": "напр., 'рефактори цю функцію для більшої ефективності'",
  "kilocode:autocomplete.commands.generateSuggestions": "VCP Code: Генерувати Запропоновані Правки",
  ...
  "kilocode:autocomplete.codeAction.title": "VCP Code: Запропоновані Правки",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "VCP Code Autocomplete блокується конфліктом з GitHub Copilot. Щоб виправити це, ти повинен вимкнути вбудовані пропозиції Copilot.",
