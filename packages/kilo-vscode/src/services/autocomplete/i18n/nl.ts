...
export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.disabled": "VCP Code Autocomplete (uitgeschakeld)",
  "kilocode:autocomplete.statusBar.tooltip.noCredits":
    "**Geen tegoed op je account**\n\nJe VCP Code account heeft geen tegoed. Om autocomplete te gebruiken, voeg tegoed toe aan je account.\n\n[Instellingen openen](command:vcp-code.new.settingsButtonClicked)",
  ...
  "kilocode:autocomplete.input.title": "VCP Code: Snelle Taak",
  "kilocode:autocomplete.input.placeholder": "bijv., 'refactor deze functie om efficiënter te zijn'",
  "kilocode:autocomplete.commands.generateSuggestions": "VCP Code: Voorgestelde Bewerkingen Genereren",
  ...
  "kilocode:autocomplete.codeAction.title": "VCP Code: Voorgestelde Bewerkingen",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "De VCP Code Autocomplete wordt geblokkeerd door een conflict met GitHub Copilot. Om dit op te lossen, moet je Copilot's inline suggesties uitschakelen.",
