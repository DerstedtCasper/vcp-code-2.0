...
**Action:** Install the VCP CLI to enable AI-assisted terminal workflows:
...
**Action:** Use [VCP Deploy](/docs/deploy-secure/deploy) to spin up live URLs for branches, allowing your team to verify changes before merging.
...
Most teams start with Code mode and stop there. But VCP's other modes unlock additional value.
...
4. Consider VCP Deploy to validate AI output
