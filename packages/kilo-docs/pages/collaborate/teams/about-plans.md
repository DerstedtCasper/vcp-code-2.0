---
title: "About Plans"
description: "Overview of VCP Code plans and pricing"
---

# About Plans

VCP Code accelerates development with AI-driven code generation and task automation. You can use VCP Code as an open source extension in VS Code or JetBrains IDEs.
...
VCP Code's paid plans, Teams and Enterprise, are the solution for these organizations.

{% callout type="note" %}

Purchases of VCP Code's paid plans are separate from model provider credits.

No credits are included with a Teams or Enterprise plan purchase.

{% /callout %}

## What You Get from VCP Teams
...
## What You Get from VCP Enterprise
...
**Cost:** [Contact Sales](https://github.com/DerstedtCasper/vcp-code-2.0/discussions)
