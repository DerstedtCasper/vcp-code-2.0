---
title: "Collaborate"
description: "Work together with VCP Code team features"
---

# {% $markdoc.frontmatter.title %}

{% callout type="generic" %}
VCP Code makes it easy to work together with your team. Share sessions, manage team settings, and track AI adoption across your organization.
{% /callout %}

## Sessions & Sharing

Sessions are your platform-agnostic interaction with VCP. They remember your repository, task, and conversation so you can pause and resume work without losing context.

- [**Sessions & Sharing**](/docs/collaborate/sessions-sharing) — Share and collaborate on VCP Code sessions
...
VCP Code's paid plans provide powerful team management features:
...
- **Enterprise ([Contact Sales](https://github.com/DerstedtCasper/vcp-code-2.0/discussions))** — Model controls, audit logs, SSO, dedicated support
...
1. [Install VCP Code](/docs/getting-started/installing) in your preferred environment
