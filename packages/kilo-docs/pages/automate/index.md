---
title: "Automate"
description: "Automate your development workflows with VCP Code"
---

# {% $markdoc.frontmatter.title %}

{% callout type="generic" %}
Automate repetitive tasks, set up AI-powered code reviews, and extend VCP Code's capabilities with integrations and MCP servers.
{% /callout %}
...
Connect VCP Code to external tools and services:
...
- [**Using MCP in VCP Code**](/docs/automate/mcp/using-in-VCP-code) — Configuration guide
...
Connect VCP Code with your development tools:
...
Customize and extend VCP Code's capabilities:
...
2. Configure [MCP servers](/docs/automate/mcp/using-in-VCP-code) for external integrations
