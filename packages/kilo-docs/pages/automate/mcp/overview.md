...
The Model Context Protocol (MCP) is a standard for extending VCP Code's capabilities by connecting to external tools and services. MCP servers provide additional tools and resources that help VCP Code accomplish tasks beyond its built-in capabilities, such as accessing databases, custom APIs, and specialized functionality.

## MCP Documentation

This documentation is organized into several sections:

- [**Using MCP in VCP Code**](using-in-VCP-code) - Comprehensive guide to configuring, enabling, and managing MCP servers with VCP Code. Includes server settings, tool approval, and troubleshooting.
...
Have you created an MCP server that others might find useful? Share it with the community by contributing to the [VCP Marketplace](https://github.com/DerstedtCasper/vcp-code-2.0)!
...
2. **Test thoroughly**: Ensure your server works correctly with VCP Code and handles edge cases gracefully
