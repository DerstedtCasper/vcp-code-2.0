...
# Using v0 With VCP Code

VCP Code supports v0, Vercel's AI model provider that offers an OpenAI-compatible API. This allows you to use v0's models with VCP Code through the familiar OpenAI API interface.

## Prerequisites

To use v0 with VCP Code, you'll need:
...
Setting up v0 in VCP Code is straightforward:

1. In VCP Code settings (click the {% codicon name="gear" /%} icon):
...
<!-- <img src="/docs/img/providers/v0-setup.png" alt="v0 configuration in VCP Code settings" width="600" /> -->
