...
test.skip("can create a workspace", async ({ page, withProject }) => {
  test.skip(process.platform === "win32", "Skipping on Windows due to workspace creation issues") // novacode_change
  await page.setViewportSize({ width: 1400, height: 800 })
...
test.skip("can rename a workspace", async ({ page, withProject }) => {
  test.skip(process.platform === "win32", "Skipping on Windows due to workspace interaction issues") // novacode_change
  await page.setViewportSize({ width: 1400, height: 800 })
