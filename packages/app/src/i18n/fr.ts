export const dict = {
  ...
  "toast.update.description":
    "Une nouvelle version d'VCP ({{version}}) est maintenant disponible pour installation.",
  ...
  "sidebar.gettingStarted.line1":
    "VCP inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur VCP dans WSL sur Windows.",
