---
title: "Deploy"
description: "Deploy your applications with Nova Code"
---

# Deploy

Kilo Deploy lets you ship **Next.js** and **static sites** directly from Nova Code, with:

- **One-click deployment** from the Nova Code dashboard
...
2. Click **Configure** and follow the prompts to connect GitHub to Nova Code
