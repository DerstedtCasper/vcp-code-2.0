---
title: "Deploy & Secure"
description: "Deploy applications and manage security with Nova Code"
---

# {% $markdoc.frontmatter.title %}

{% callout type="generic" %}
Deploy your applications directly from Nova Code and manage security with AI-powered reviews and scans.
{% /callout %}
