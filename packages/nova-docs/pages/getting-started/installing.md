---
title: "Installation"
description: "How to install Nova Code on your system"
---

# Installation

Get started with Nova Code by installing it on your preferred platform. Choose your development environment below:
...
For VS Code-compatible editors like VSCodium, Gitpod, Eclipse Theia, and Windsurf, you can browse and install directly from the [Nova Code page on Open VSX Registry](https://open-vsx.org/extension/novacode/Kilo-Code).
...
4. Search for "Nova Code"
5. Select "Nova Code" and click **Install**
...
{% image src="/docs/img/installing-vsix.png" alt="Installing Nova Code using VS Code's Install from VSIX dialog" width="600px" caption="Installing Nova Code using VS Code's \"Install from VSIX\" dialog" /%}
...
- Restart VS Code
- Verify Nova Code is listed and enabled in Extensions
- Try disabling and re-enabling the extension in Extensions
- Check Output panel for errors (View → Output, select "Nova Code")
...
- [Your First Task](/docs/code-with-ai/agents/chat-interface) - Learn the basics of working with Nova Code
