...
As you work with Nova Code, each task creates files containing conversation history, checkpoints, and other data. Over time, this accumulates and can consume significant disk space. Auto-Cleanup solves this by:
...
Access Auto-Cleanup settings through the Nova Code settings panel:

1. Click the gear icon ({% codicon name="gear" /%}) in Nova Code
...
- **macOS**: `~/Library/Application Support/Code/User/globalStorage/novacode.kilo-code/`
- **Windows**: `%APPDATA%\Code\User\globalStorage\novacode.kilo-code\`
- **Linux**: `~/.config/Code/User/globalStorage/novacode.kilo-code/`
