---
title: "About Plans"
description: "Overview of Nova Code plans and pricing"
---

# About Plans

Nova Code accelerates development with AI-driven code generation and task automation. You can use Nova Code as an open source extension in VS Code or JetBrains IDEs.
...
Nova Code's paid plans, Teams and Enterprise, are the solution for these organizations.

{% callout type="note" %}

Purchases of Nova Code's paid plans are separate from model provider credits.
