---
title: "Collaborate"
description: "Work together with Nova Code team features"
---

# {% $markdoc.frontmatter.title %}

{% callout type="generic" %}
Nova Code makes it easy to work together with your team. Share sessions, manage team settings, and track AI adoption across your organization.
{% /callout %}
...
- [**Sessions & Sharing**](/docs/collaborate/sessions-sharing) — Share and collaborate on Nova Code sessions
...
Nova Code's paid plans provide powerful team management features:
...
1. [Install Nova Code](/docs/getting-started/installing) in your preferred environment
