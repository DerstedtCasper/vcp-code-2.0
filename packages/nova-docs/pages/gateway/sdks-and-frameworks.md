...
The Kilo AI Gateway is OpenAI-compatible, meaning any SDK or framework that works with the OpenAI API can work with the Nova Gateway by changing the base URL.
...
The official OpenAI SDKs work with the Nova Gateway by setting the base URL.
