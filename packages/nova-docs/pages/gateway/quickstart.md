...
For step-by-step instructions on getting an API key, please see the [Nova Gateway API Key instructions](/docs/getting-started/setup-authentication#nova-gateway-api-key).
