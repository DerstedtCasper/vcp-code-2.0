...
description: "A guide for Cline contributors who want to start contributing to Nova Code"
---

# Cline to Kilo: Contributor Migration Guide

If you've been contributing to Cline and you're ready to bring those skills over to Nova Code, you're in the right place. This guide will walk you through what's different, what's the same, and how to get up and running as a Kilo contributor.
