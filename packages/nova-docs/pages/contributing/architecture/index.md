...
description: "Overview of Nova Code architecture"
---

# Architecture Overview

This document provides a high-level overview of Nova Code's architecture to help contributors understand how the different components fit together.

## System Architecture

Nova Code is a VS Code extension built with TypeScript that connects to various AI providers to deliver intelligent coding assistance. The architecture follows a layered approach:
...
Modes are configurable presets that customize Nova Code's behavior:
...
MCP enables extending Nova Code with external tools:
