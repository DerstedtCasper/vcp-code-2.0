...
const terminalContent = {
  installation: (
    <>
      <span className="terminal-comment"># Install Nova Code VS Code Extension</span>
      {"\n"}
      <span className="terminal-prompt">$</span> code --install-extension novacode.kilo-code
      {"\n"}
      {"\n"}
      <span className="terminal-comment"># Or install via CLI</span>
      {"\n"}
      <span className="terminal-prompt">$</span> npm install -g @novacode/cli
    </>
  ),
  gateway: (
    <>
      <span className="terminal-comment"># Call Nova Gateway with a quick curl script</span>
      {"\n"}
      ...
      {`  -d '{"model":"anthropic/claude-sonnet-4.5","messages":[{"role":"user","content":"Say hi from Nova Gateway"}]}'`}
    </>
  ),
  firstTask: (
    <>
      <span className="terminal-comment"># Start a new task with Nova Code</span>
      {"\n"}
  ...
  customRules: (
    <>
      ...
      {"\n"}
      <span className="terminal-prompt">$</span> touch .novacode/rules.md
      {"\n"}
      {"\n"}
...
const categories = [
  {
    title: "Get Started",
    description: "Install Nova Code and get up and running in minutes",
  ...
  {
    title: "Code with AI",
    description: "Learn how to use Nova Code to write, edit, and understand code",
    href: "/code-with-ai",
    icon: (
      <svg className="category-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
  ...
  {
    title: "Contributing",
    description: "Help improve Nova Code and learn about its architecture",
    href: "/contributing",
    icon: (
      <svg className="category-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
        <path
    ...
    <div className="homepage">
      ...
      <section className="hero">
        <div className="hero-content">
          <h1 className="hero-title">Nova Code Documentation</h1>
          <p className="hero-subtitle">
            Explore our guides and examples to build with Nova Code, the most popular open source coding agent.
          </p>
          <div className="hero-buttons">
            <Link href="/getting-started" className="btn btn-primary">
              Get started with Nova Code →
            </Link>
      ...
      <section className="terminal-section">
        <div className="terminal-intro">
          ...
          <p className="terminal-description">Get started quickly with common Nova Code commands</p>
        </div>
