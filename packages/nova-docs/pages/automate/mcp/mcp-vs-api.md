...
## Why Nova Code Uses MCP

Nova Code leverages MCP to provide:
...
MCP creates a universal connector between Nova Code and external services, with REST APIs often powering those services behind the scenes.
