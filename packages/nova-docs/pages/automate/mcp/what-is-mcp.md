...
Nova Code implements the Model Context Protocol to:
...
- [Using MCP in Nova Code](using-in-kilo-code) - Get started with MCP in Nova Code, including creating simple servers
