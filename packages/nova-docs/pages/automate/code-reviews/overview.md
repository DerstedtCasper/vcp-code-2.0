...
- **Nova Code credits:** The AI model uses credits when analyzing your code.
...
- **Nova Code credits are still used** when the agent performs model reasoning during a review.
