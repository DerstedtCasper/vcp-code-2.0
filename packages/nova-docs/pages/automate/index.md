---
title: "Automate"
description: "Automate your development workflows with Nova Code"
---

# {% $markdoc.frontmatter.title %}

{% callout type="generic" %}
Automate repetitive tasks, set up AI-powered code reviews, and extend Nova Code's capabilities with integrations and MCP servers.
{% /callout %}
...
Connect Nova Code to external tools and services:
...
- [**Using MCP in Nova Code**](/docs/automate/mcp/using-in-kilo-code) — Configuration guide
...
Connect Nova Code with your development tools:
...
Customize and extend Nova Code's capabilities:
