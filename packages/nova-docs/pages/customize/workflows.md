---
title: "Workflows"
description: "Create automated workflows with Nova Code"
---

# Workflows

Workflows automate repetitive tasks by defining step-by-step instructions for Nova Code to execute. Invoke any workflow by typing `/[workflow-name.md]` in the chat.

{% image src="/docs/img/slash-commands/workflows.png" alt="Workflows tab in Nova Code" width="600" caption="Workflows tab in Nova Code" /%}

## Creating Workflows

Workflows are markdown files stored in `.novacode/workflows/`:

- **Global workflows**: `~/.novacode/workflows/` (available in all projects)
- **Project workflows**: `[project]/.novacode/workflows/` (project-specific)
...
Create a file called `submit-pr.md` in your `.novacode/workflows` directory:
...
Now you can trigger this workflow by typing `/submit-pr.md` in the chat. Nova Code will:
