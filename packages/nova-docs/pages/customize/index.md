---
title: "Customize"
description: "Make Nova Code work your way with custom modes, rules, instructions, and more"
---

# {% $markdoc.frontmatter.title %}

{% callout type="generic" %}
Nova Code is highly customizable. Tailor its behavior to match your workflow, team standards, and project requirements with custom modes, rules, instructions, and more.
{% /callout %}

## Customization

Configure how Nova Code behaves and responds:
...
1. **Start with Custom Instructions** — Set up instructions in the [Custom Instructions](/docs/customize/custom-instructions) section to guide Nova Code's behavior
