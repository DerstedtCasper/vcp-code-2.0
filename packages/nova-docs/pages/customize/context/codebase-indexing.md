...
Codebase Indexing enables semantic code search across your entire project using AI embeddings. Instead of searching for exact text matches, it understands the _meaning_ of your queries, helping Nova Code find relevant code even when you don't know specific function names or file locations.
...
4. **Provides the [`codebase_search`](/docs/automate/tools/codebase-search) tool** to Nova Code for intelligent code discovery
...
- **Enhanced AI Understanding**: Nova Code can better comprehend and work with your codebase
...
3. If you don't see the icon, open Nova Code settings (<Codicon name="gear" />) and search for **Codebase Indexing**
...
- Files matching `.gitignore` and [`.novacodeignore`](/docs/customize/context/novacodeignore) patterns
...
Once indexed, Nova Code can use the [`codebase_search`](/docs/automate/tools/codebase-search) tool to find relevant code:
...
The tool provides Nova Code with:
