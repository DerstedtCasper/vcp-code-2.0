---
title: "Slack"
description: "Using Nova Code in Slack"
---

# Kilo for Slack

Kilo for Slack brings the power of Nova Code directly into your Slack workspace. Ask questions about your repositories, request code implementations, or get help with issues—all without leaving Slack.
...
- You must have a **Nova Code account** with available credits
...
3. **AI generates a response** — Nova Code's AI analyzes your request and provides helpful responses
...
- **Nova Code credits are used** when Kilo performs work (model usage, operations, etc.)
- Credit usage is similar to using Nova Code through other interfaces
