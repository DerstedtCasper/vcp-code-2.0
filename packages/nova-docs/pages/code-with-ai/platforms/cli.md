...
**Source code & issues (Kilo CLI 1.0):** [Kilo-Org/novacode](https://github.com/Kilo-Org/novacode) · [Report an issue](https://github.com/Kilo-Org/novacode/issues)
...
The Kilo CLI is a fork of [OpenCode](https://opencode.ai) and supports the same configuration options. The CLI you install with `npm install -g @novacode/cli` (Kilo CLI 1.0) is built from [Kilo-Org/novacode](https://github.com/Kilo-Org/novacode). For comprehensive configuration documentation, see the [OpenCode Config documentation](https://opencode.ai/docs/config).
