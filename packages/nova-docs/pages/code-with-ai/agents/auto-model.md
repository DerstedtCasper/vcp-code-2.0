...
Auto Model is a new feature and we're actively improving it. We'd love to hear how it's working for you! Share feedback in our [Discord](https://discord.gg/novacode) or [open an issue on GitHub](https://github.com/Kilo-Org/novacode/issues).
{% /callout %}
