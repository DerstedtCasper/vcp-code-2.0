...
description: Learn how to use Nova Code effectively while minimizing or eliminating costs through free models, budget-friendly alternatives, and smart usage strategies.
---

# Free and Budget Models

**Why this matters:** AI model costs can add up quickly during development. This guide shows you how to use Nova Code effectively while minimizing or eliminating costs through free models, budget-friendly alternatives, and smart usage strategies.

## Completely Free Options

### Nova Gateway Free Models

From time to time, Kilo works with AI inference providers to offer free models. These are available through the Nova Gateway. Currently, we are offering these free models:
...
3. Configure Nova Code with the OpenRouter provider
...
2. **Configure multiple providers** in Nova Code
