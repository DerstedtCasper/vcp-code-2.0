---
title: "Code with AI"
description: "Learn how to code with AI using Nova Code across different platforms and interfaces"
---

# {% $markdoc.frontmatter.title %}

{% callout type="generic" %}
Nova Code is your AI pair programmer that works in your IDE, terminal, or browser. Generate code, refactor, debug, and ship faster with AI that understands your codebase and context.
{% /callout %}

## Getting Started

New to Nova Code? Start here to understand the core concepts:

- [**Install Nova Code**](/docs/getting-started/installing) — Get started in VS Code, JetBrains, CLI, or mobile
...
Use Nova Code wherever you work:
