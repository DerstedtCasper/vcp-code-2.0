---
title: "Browser Use"
description: "Using Nova Code to interact with web browsers"
---

# Browser Use

Nova Code provides browser automation capabilities that let you interact with websites directly from your coding workflow. This feature supports testing web applications, automating browser tasks, and capturing screenshots without leaving your editor.
...
By default, Nova Code uses a built-in browser that:
...
- `Can you check if my website at https://novacode.ai is displaying correctly?`
...
**Purpose**: Determines the resolution of the browser session Nova Code uses.
