...
# Using v0 With Nova Code

Nova Code supports v0, Vercel's AI model provider that offers an OpenAI-compatible API. This allows you to use v0's models with Nova Code through the familiar OpenAI API interface.

## Prerequisites

To use v0 with Nova Code, you'll need:
...
Setting up v0 in Nova Code is straightforward:

1. In Nova Code settings (click the {% codicon name="gear" /%} icon):
...
<!-- <img src="/docs/img/providers/v0-setup.png" alt="v0 configuration in Nova Code settings" width="600" /> -->
