---
title: Fireworks AI with Nova Code
---

# Using Fireworks AI With Nova Code
...
3. **Create a Key:** Click "Create API key" and give your key a descriptive name (e.g., "Nova Code").
