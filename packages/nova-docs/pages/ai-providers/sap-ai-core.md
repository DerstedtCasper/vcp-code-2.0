...
# Using SAP AI Core With Nova Code

Nova Code supports accessing models through SAP AI Core, a service in the SAP Business Technology Platform that lets you efficiently run AI scenarios in a standardized, scalable, and hyperscaler-agnostic manner.
...
To use SAP AI Core with Nova Code, you'll need to create a service key for your SAP AI Core service instance:
...
Nova Code applies the following filters when fetching models:
...
3. Configure Nova Code with your credentials
