---
title: "AI Providers"
description: "Configure and connect different AI model providers to Nova Code"
---

# AI Providers

Nova Code supports a wide variety of AI providers, giving you flexibility in how you power your AI-assisted development workflow. Choose from cloud providers, local models, or AI gateways based on your needs.

## Getting Started

The fastest way to get started is with **Nova Code's built-in provider**, which requires no configuration. Simply sign in and start coding.
...
| --------------- | --------------------------------------------------- |
| Ease of use     | [Nova Code (built-in)](/docs/ai-providers/novacode) |
...
- **New to Nova Code?** Start with the [Nova Code provider](/docs/ai-providers/novacode) - no setup required
