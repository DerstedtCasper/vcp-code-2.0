...
1. Click "Try Nova Code for Free" in the Kilo panel
2. Sign in with OAuth at kilo.ai
3. You'll be redirected back to your IDE

### Configure your provider

**Option 1: Use Nova Gateway (easiest)**

1. Open settings (⚙️ icon)
2. Select "Nova Gateway" as provider
...
4. Install the Kilo CLI with `npm install -g @novacode/cli`
