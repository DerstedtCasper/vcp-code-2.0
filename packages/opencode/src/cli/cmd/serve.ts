...
export const ServeCommand = cmd({
  ...
  describe: "starts a headless kilo server", // novacode_change
  handler: async (args) => {
    ...
    console.log(`kilo server listening on http://${server.hostname}:${server.port}`) // novacode_change
    // novacode_change start - graceful signal shutdown
