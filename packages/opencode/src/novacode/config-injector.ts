...
import { RulesMigrator } from "./rules-migrator" // novacode_change
import { WorkflowsMigrator } from "./workflows-migrator"
import { IgnoreMigrator } from "./ignore-migrator" // novacode_change

export namespace NovacodeConfigInjector {
  ...
  export async function buildConfig(options: {
    ...
    // novacode_change start - Rules migration
    ...
    // novacode_change start - Ignore migration
   ...
   * Incoming rules take precedence (novacode patterns override).
   */
