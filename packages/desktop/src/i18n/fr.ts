export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'VCP",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'VCP a été téléchargée. Voulez-vous l'installer et redémarrer ?",
